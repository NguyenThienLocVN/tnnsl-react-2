                    ...
                    <div className="menu-home col-12 p-0 col-lg-9 discharge-water">
                        <form className="needs-validation" onSubmit={this.submitHandler} noValidate>
                            ...
                            <div className="col-12 row m-0 p-0">
                                ...
                                <div className="col-sm-6">
                                    <div className="mb-2">
                                        <label htmlFor="congtrinh_ten" className="form-label fw-bold m-0">2.1.Vị trí công trình  khoan nước dưới đất</label>
                                ...
                                <div className="col-sm-6">
                                    <div className="mb-2">
                                        <label htmlFor="congtrinh_diadiem" className="form-label fw-bold m-0">2.2.Mục đích khoan nước dưới đất</label>
                                ...
                                <div className="col-sm-6">
                                    <div className="mb-2">
                                        <label htmlFor="mucdich_ktsd" className="form-label fw-bold m-0">2.3.Quy mô khoan</label>
                                ...
                                <div className="col-sm-6">
                                    <div className="mb-2">
                                        <label htmlFor="tangchuanuoc_license" className="form-label fw-bold m-0">2.4.Tầng chứa nước khoan nước dưới đất</label>
                                ...
                                <div className="col-sm-12">
                                    <div className="mb-2 row m-0">
                                        <label className="form-label fw-bold col-12 p-0">2.8.Khối lượng hạng mục khoan chủ yếu</label>
