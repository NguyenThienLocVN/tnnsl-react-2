                            ...
                            <div>
                                ...
                                <div className="2">
                                    ...
                                    <div className="row m-0">
                                        <div className="col-sm-6">
                                            <div className="mb-2">
                                                <label htmlFor="congtrinh_ten" className="form-label fw-bold font-13 m-0">2.1.Tên công trình khoan</label>
                                                <input type="text" required className="form-control form-control-sm" id="congtrinh_ten" name="congtrinh_ten"  />
                                            </div>
                                        </div>
                                        <div className="col-sm-6">
                                            <div className="mb-2">
                                                <label htmlFor="mucdich_ktsd" className="form-label fw-bold font-13 m-0">2.2.Mục đích khoan, sử dụng nước</label>
                                                <input type="text" required className="form-control form-control-sm" id="mucdich_ktsd" name="mucdich_ktsd"  />
                                            </div>
                                        </div>
                                        <div className="col-sm-6">
                                            <div className="mb-2">
                                                <label htmlFor="congtrinh_diadiem" className="form-label fw-bold font-13 m-0">2.3.Vị trí công trình khoan nước dưới đất</label>
                                                <input type="text" required className="form-control form-control-sm" id="congtrinh_diadiem" name="congtrinh_diadiem"  />
                                            </div>
                                        </div>
                                        <div className="col-sm-6">
                                            <div className="mb-2">
                                                <label htmlFor="tangchuanuoc" className="form-label fw-bold font-13 m-0">2.4.Tầng chứa nước khoan</label>
                                                <input type="text" required className="form-control form-control-sm" id="tangchuanuoc" name="tangchuanuoc"  />
                                            </div>
                                        </div>
                                        <div className="col-sm-6">
                                            <div className="mb-2">
                                                <label htmlFor="sogieng_quantrac" className="form-label fw-bold font-13 m-0">2.5.Số giếng khoan</label>
                                                <input type="text" required className="form-control form-control-sm" id="sogieng_quantrac" name="sogieng_quantrac"  />
                                            </div>
                                        </div>
                                        <div className="col-sm-6">
                                            <div className="mb-2">
                                                <label htmlFor="tongluuluong_ktsd_max" className="form-label fw-bold font-13 m-0">2.6.Tổng lượng nước khoan (m3/ngày đêm)</label>
                                        ...
                                        <div className="col-sm-6">
                                            <div className="mb-2">
                                                <label htmlFor="tiencapquyen_khaithac" className="form-label fw-bold font-13 m-0">2.8.Tiền cấp quyền khoan</label>
