...
export default class QuanLyCapPhepNuocDuoiDatThamDoGiaHan extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Nước dưới đất - gia hạn giấy phép";
        trackPromise(
            axios
                    ...
                    <div className="menu-home col-12 p-0 col-lg-9 discharge-water">
                        <form>
                            ...
                            <div className="col-12 row m-0 p-0">
                                ...
                                <div className="col-sm-6">
                                    <div className="mb-2">
                                        <label htmlFor="tongluuluong_ktsd_max" className="form-label fw-bold m-0">2.5.Lý do đề nghị gia hạn giấy phép thăm dò nước dưới đất</label>
                                        <input type="text" className="form-control form-control-sm" id="tongluuluong_ktsd_max" />
                                    </div>
                                </div>
                                <div className="col-sm-6">
                                    <div className="mb-2">
                                        <label htmlFor="gp_thoigiancapphep" className="form-label fw-bold m-0">2.6.Thời gian đề nghị  gia hạn giấy phép</label>
