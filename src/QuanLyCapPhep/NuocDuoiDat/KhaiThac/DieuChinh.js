...
export default class QuanLyCapPhepNuocDuoiDatKhaiThacDieuChinh extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
                    ...
                    <div className="menu-home col-12 p-0 col-lg-9 discharge-water">
                        <form>
                            ...
                            <div className="col-12 row m-0 p-0">
                                ...
                                <div className="col-sm-6">
                                    <div className="mb-2">
                                        <label htmlFor="gp_thoigiancapphep" className="form-label fw-bold m-0">2.7.Lý do đề nghị điều chỉnh giấy phép</label>
                                        <input type="text" className="form-control form-control-sm" id="gp_thoigiancapphep" />
                                    </div>
                                </div>
                                <div className="col-sm-6">
                                    <div className="mb-2">
                                        <label htmlFor="gp_thoigiancapphep" className="form-label fw-bold m-0">2.8.Nội dung đề nghị điều chỉnh giấy phép</label>
                                        <input type="text" className="form-control form-control-sm" id="gp_thoigiancapphep" />
                                    </div>
                                </div>
