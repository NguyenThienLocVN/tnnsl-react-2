...
export default class QuanLyCapPhepuocDuoiDatKhaiThacTheoDoiGiayPhep extends React.Component {

    render(){
        return(
			<div className="p-0">
                <Header headTitle="THÔNG TIN THEO DÕI CÔNG TRÌNH SAU CẤP PHÉP KHAI THAC SỬ DỤNG NƯỚC DƯỚI ĐẤT" previousLink="/quan-ly-cap-phep/nuoc-duoi-dat/khai-thac" showHeadImage={true} layoutfull={true} />
                        ...
                        <form>
                            <div>
                                ...
                                <div className="row m-0 justify-content-between mb-5 px-4">
                                    <buuton type="button" className="col-sm-2 btn btn-sm btn-primary">Sửa</buuton>
                                    <buuton type="button" className="col-sm-2 btn btn-sm btn-primary">Xóa</buuton>
                                    <buuton type="button" className="col-sm-2 btn btn-sm btn-primary">Ghi</buuton>
                                    <buuton type="button" className="col-sm-2 btn btn-sm btn-primary">In</buuton>
                                    <buuton type="button" className="col-sm-2 btn btn-sm btn-primary">Xuất PDF</buuton>
                                </div>
                            </div>
                        </form>
                    </div>
