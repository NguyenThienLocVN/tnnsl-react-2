...
export default class QuanLyCapPhepKhaiThacGiaHanDieuChinhNDD extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ GIA HẠN, ĐIỀU CHỈNH GIẤY PHÉP CÔNG TRÌNH KHÁC NƯỚC DƯỚI ĐẤT" previousLink="/quan-ly-cap-phep/nuoc-duoi-dat/cong-trinh-khac" showHeadImage={true} layoutfull={true} />
