...
export default class QuanLyCapPhepXaThaiChanNuoi extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Xả thải - chăn nuôi, ntts";
    ...
    render(){        
            ...
            },
            {
                ...
                render: (text, record) => (
                    <div className="d-flex align-items-center justify-content-center">
                        <Link to={"/quan-ly-cap-phep/xa-thai-chan-nuoi/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP PHÉP XẢ THẢI CHĂN NUÔI/ NUÔI TRỒNG THỦY SẢN" previousLink="/quan-ly-cap-phep" showHeadImage={true} layout48={true} />
