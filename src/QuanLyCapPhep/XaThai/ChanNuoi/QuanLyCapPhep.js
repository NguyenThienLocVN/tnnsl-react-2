...
const user = getUser();
export default class QuanLyCapPhepXaThaiKhuDanCu extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    render(){
                ...
                render: (text, record, i) => (
                    <>
                        <div className="d-flex">
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-chan-nuoi/theo-doi/"+record.id} title="Theo Dõi"><EyeOutlined /></Link>
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-chan-nuoi/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP MỚI GIẤY PHÉP XẢ THẢI CHĂN NUÔI/ NUOI TRỒNG THỦY SẢN" previousLink="/quan-ly-cap-phep/xa-thai-chan-nuoi/" showHeadImage={true} layoutfull={true} />
