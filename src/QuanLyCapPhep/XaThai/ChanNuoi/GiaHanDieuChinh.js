...
export default class QuanLyCapPhepGiaHanDieuChinhXaThaiChanNuoi extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Gia hạn/ điều chỉnh giấy phép xả thải chăn nuôi, ntts";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ GIA HẠN, ĐIỀU CHỈNH GIẤY PHÉP XẢ THẢI CHĂN NUÔI/ NUÔI TRỒNG THỦY SẢN" previousLink="/quan-ly-cap-phep/xa-thai-chan-nuoi" showHeadImage={true} layoutfull={true} />
