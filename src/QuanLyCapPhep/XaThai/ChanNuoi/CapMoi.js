...
export default class QuanLyCapPhepCapMoiXaThaiChanNuoi extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Cấp mới giấy phép xả thải chăn nuôi, ntts";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CẤP MỚI GIẤY PHÉP XẢ THẢI CHĂN NUÔI/ NUÔI TRỒNG THỦY SẢN" previousLink="/quan-ly-cap-phep/xa-thai-chan-nuoi" showHeadImage={true} layoutfull={true} />
