...
export default class QuanLyCapPhepSuaGiayPhepXaThaiChanNuoi extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Sửa giấy phép xả thải chăn nuôi, ntts";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CHỈNH SỬA GIẤY PHÉP XẢ THẢI CHĂN NUÔI/ NUÔI TRỒNG THỦY SẢN" previousLink="/quan-ly-cap-phep/xa-thai-chan-nuoi" showHeadImage={true} layoutfull={true} />
                        ...
                        <form className="needs-validation" onSubmit={this.submitHandler} noValidate>
                            ...
                            <div className="col-sm-12 row m-0 p-0">
                                ...
                                <div className="col-sm-4">
                                    <div className="mb-2">
                                        <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0">3.1.Nguồn nước tiếp nhận nước thải</label>
                                        <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                    </div>
                                </div>
                                <div className="col-sm-4">
                                    <div className="mb-2">
                                        <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0">3.2.Vị trí xả nước thải</label>
                                        <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                    </div>
                                </div>
                                <div className="col-sm-4">
                                    <div className="mb-2">
                                        <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0">3.3.Tọa độ vị trí xả nước thải (hệ tọa độ VN2000)</label>
                                        <div className="row m-0">
                                            <div className="col-sm-6 d-flex align-items-center">
                                                <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0 w-25 text-end pe-2">X:</label>
                                                <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm w-75" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                            </div>
                                            <div className="col-sm-6 d-flex align-items-center">
                                                <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0 w-25 text-end pe-2">Y:</label>
                                                <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm w-75" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-sm-3">
                                    <div className="mb-2">
                                        <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0">3.4.Phương thức xả nước thải</label>
                                        <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                    </div>
                                </div>
                                <div className="col-sm-3">
                                    <div className="mb-2">
                                        <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0">3.5.Chế độ xả nước thải</label>
                                        <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                    </div>
                                </div>
                                <div className="col-sm-3">
                                    <div className="mb-2">
                                        <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0">3.6.Lưu lượng xả trung bình (m3/ngày đêm)</label>
                                        <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                    </div>
                                </div>
                                <div className="col-sm-3">
                                    <div className="mb-2">
                                        <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0">3.7.Lưu lượng xả lớn nhất (m3/ngày đêm)</label>
                                        <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                    </div>
                                </div>
                                <div className="col-sm-2">
                                    <div className="mb-2">
                                        <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0">3.8.Hệ số Kq</label>
                                        <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                    </div>
                                </div>
                                <div className="col-sm-2">
                                    <div className="mb-2">
                                        <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0">3.9.Hệ số Kf</label>
                                        <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                    </div>
                                </div>
                                <div className="col-sm-4">
                                    <div className="mb-2">
                                        <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0">3.10.Quy chuẩn quốc gia về chất lượng nước thải</label>
                                        <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                    </div>
                                </div>
                                <div className="col-sm-4">
                                    <div className="mb-2">
                                        <label htmlFor="tailieu_donxincapphep" className="form-label fw-bold font-13 m-0">3.11.Thời gian đề nghị cấp phép</label>
                                        <input type="text" onChange={this.handleInputChange} className="form-control form-control-sm" id="tailieu_donxincapphep" name="tailieu_donxincapphep" />
                                    </div>
                                </div>
                            ...
                            <div className="pb-4 text-center col-sm-12">
                                <hr />
                                <button type="submit" className="btn btn-primary mx-2 fw-bold font-14">GỬI YÊU CẦU SỬA GIẤY PHÉP</button>
                            </div>
                        </form>
                    </div>
                </main>
