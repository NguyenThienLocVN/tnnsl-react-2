...
export default class QuanLyCapPhepTheoDoiGiayPhepXaThaiChanNuoi extends React.Component {

    render(){
        return(
			<div className="p-0">
                <Header headTitle="THÔNG TIN THEO DÕI CÔNG TRÌNH SAU CẤP PHÉP XẢ THẢI CHĂN NUÔI/ NUÔI TRỒNG THỦY SẢN" previousLink="/quan-ly-cap-phep/xa-thai-chan-nuoi/quan-ly-cap-moi" showHeadImage={true} layoutfull={true} />
