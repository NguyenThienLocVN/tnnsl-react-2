...
export default class QuanLyCapPhepXaThaiCSBenhVien extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Sửa giấy phép xả thải CS bệnh viện";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CHỈNH SỬA GIẤY PHÉP XẢ THẢI CS BỆNH VIỆN" previousLink="/quan-ly-cap-phep/xa-thai-cs-benh-vien" showHeadImage={true} layoutfull={true} />
