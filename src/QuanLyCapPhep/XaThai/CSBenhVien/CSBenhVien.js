...
export default class QuanLyCapPhepXaThaiCSBenhVien extends React.Component {
    ...
    componentDidMount(){
        document.title = "Xả thải - CS bệnh viện";
    ...
    render(){        
            ...
            },
            {
                ...
                render: (text, record) => (
                    <div className="d-flex align-items-center justify-content-center">
                        <Link to={"/quan-ly-cap-phep/xa-thai-cs-benh-vien/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP PHÉP XẢ THẢI CS BỆNH VIỆN" previousLink="/quan-ly-cap-phep" showHeadImage={true} layout48={true} />
