...
export default class QuanLyCapPhepXaThaiCSBenhVien extends React.Component {
    ...
    render(){
                ...
                render: (text, record, i) => (
                    <>
                        <div className="d-flex">
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-cs-benh-vien/theo-doi/"+record.id} title="Theo Dõi"><EyeOutlined /></Link>
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-cs-benh-vien/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP MỚI GIẤY PHÉP XẢ THẢI CS BỆNH VIỆN" previousLink="/quan-ly-cap-phep/xa-thai-cs-benh-vien/" showHeadImage={true} layoutfull={true} />
