...
export default class QuanLyCapPhepXaThaiCSBenhVien extends React.Component {
    ...
    componentDidMount(){
        document.title = "Cấp mới giấy phép xả thải CS bệnh viện";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CẤP MỚI GIẤY PHÉP XẢ THẢI CS BỆNH VIỆN" previousLink="/quan-ly-cap-phep/xa-thai-cs-benh-vien" showHeadImage={true} layoutfull={true} />
