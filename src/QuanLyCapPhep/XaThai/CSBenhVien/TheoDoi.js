...
export default class QuanLyCapPhepKhaiThacTheoDoiGiayPhepNDD extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="THÔNG TIN THEO DÕI CÔNG TRÌNH SAU CẤP PHÉP XẢ THẢI CS BỆNH VIỆN" previousLink="/quan-ly-cap-phep/xa-thai-cs-benh-vien/quan-ly-cap-moi" showHeadImage={true} layoutfull={true} />
