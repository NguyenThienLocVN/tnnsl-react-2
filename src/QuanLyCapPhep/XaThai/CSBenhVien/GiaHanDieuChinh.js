...
export default class QuanLyCapPhepGiaHanDieuChinhXaThaiCSBenhVien extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Gia hạn/ điều chỉnh giấy phép xả thải CS Bệnh viện";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ GIA HẠN, ĐIỀU CHỈNH GIẤY PHÉP XẢ THẢI CS BỆNH VIỆN" previousLink="/quan-ly-cap-phep/xa-thai-cs-benh-vien" showHeadImage={true} layoutfull={true} />
