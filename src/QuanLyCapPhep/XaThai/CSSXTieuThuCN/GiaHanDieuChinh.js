...
export default class QuanLyCapPhepGiaHanDieuChinhXaThaiCSSXTieuThuCN extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Gia hạn/ điều chỉnh giấy phép xả thải CSSX tiểu thủ CN";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ GIA HẠN, ĐIỀU CHỈNH GIẤY PHÉP XẢ THẢI CSSX TIỂU THỦ CÔNG NGHIỆP" previousLink="/quan-ly-cap-phep/xa-thai-cssx-tieu-thu-cn" showHeadImage={true} layoutfull={true} />
