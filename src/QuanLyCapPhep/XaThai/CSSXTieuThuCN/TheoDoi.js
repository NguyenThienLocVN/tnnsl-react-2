...
export default class QuanLyCapPhepKhaiThacTheoDoiGiayPhepNDD extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="THÔNG TIN THEO DÕI CÔNG TRÌNH SAU CẤP PHÉP XẢ THẢI CSSX TIỂU THỦ CÔNG NGHIỆP" previousLink="/quan-ly-cap-phep/xa-thai-cssx-tieu-thu-cn/quan-ly-cap-moi" showHeadImage={true} layoutfull={true} />
