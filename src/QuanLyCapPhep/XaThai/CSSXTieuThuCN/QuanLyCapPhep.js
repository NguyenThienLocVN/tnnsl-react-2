...
export default class QuanLyCapPhepXaThaiCSSXTieuThuCN extends React.Component {
    ...
    render(){
                ...
                render: (text, record, i) => (
                    <>
                        <div className="d-flex">
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-cssx-tieu-thu-cn/theo-doi/"+record.id} title="Theo Dõi"><EyeOutlined /></Link>
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-cssx-tieu-thu-cn/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP MỚI GIẤY PHÉP XẢ THẢI CSSX TIỂU THỦ CÔNG NGHIỆP" previousLink="/quan-ly-cap-phep/xa-thai-cssx-tieu-thu-cn/" showHeadImage={true} layoutfull={true} />
