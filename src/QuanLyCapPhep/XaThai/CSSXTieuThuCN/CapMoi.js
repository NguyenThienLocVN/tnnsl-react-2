...
export default class QuanLyCapPhepXaThaiCSSXTieuThuCN extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Cấp mới giấy phép xả thải CSSX tiểu thủ CN";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CẤP MỚI GIẤY PHÉP XẢ THẢI CSSX TIỂU THỦ CÔNG NGHIỆP" previousLink="/quan-ly-cap-phep/xa-thai-cssx-tieu-thu-cn" showHeadImage={true} layoutfull={true} />
