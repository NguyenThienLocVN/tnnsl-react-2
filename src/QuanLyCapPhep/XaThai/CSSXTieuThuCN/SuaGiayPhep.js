...
export default class QuanLyCapPhepKhaiThacCapMoiNDD extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CHỈNH SỬA GIẤY PHÉP XẢ THẢI CSSX TIỂU THỦ CÔNG NGHIỆP" previousLink="/quan-ly-cap-phep/xa-thai-cssx-tieu-thu-cn" showHeadImage={true} layoutfull={true} />
