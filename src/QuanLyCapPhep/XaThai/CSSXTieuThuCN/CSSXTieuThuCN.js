...
export default class QuanLyCapPhepXaThaiCSSXTieuThuCN extends React.Component {
    ...
    componentDidMount(){
        document.title = "Xả thải - CSSX tiểu thủ CN";
    ...
    render(){        
            ...
            },
            {
                ...
                render: (text, record) => (
                    <div className="d-flex align-items-center justify-content-center">
                        <Link to={"/quan-ly-cap-phep/xa-thai-cssx-tieu-thu-cn/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP PHÉP XẢ THẢI CSSX TIỂU THỦ CÔNG NGHIỆP" previousLink="/quan-ly-cap-phep" showHeadImage={true} layout48={true} />
