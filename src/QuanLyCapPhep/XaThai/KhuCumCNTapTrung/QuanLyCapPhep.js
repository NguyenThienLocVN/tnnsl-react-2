...
export default class QuanLyCapPhepKhaiThacQuanLyGiayPhepNDD extends React.Component {
    ...
    render(){
                ...
                render: (text, record, i) => (
                    <>
                        <div className="d-flex">
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-khu-cum-cong-nghiep-tap-trung/theo-doi/"+record.id} title="Theo Dõi"><EyeOutlined /></Link>
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-khu-cum-cong-nghiep-tap-trung/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP MỚI GIẤY PHÉP XẢ THẢI KHU CÔNG NGHIỆP TẬP TRUNG" previousLink="/quan-ly-cap-phep/xa-thai-khu-cum-cong-nghiep-tap-trung/" showHeadImage={true} layoutfull={true} />
