...
export default class QuanLyCapPhepKhaiThacCapMoiNDD extends React.Component {
    ...
    componentDidMount(){
        document.title = "Sửa giấy phép xả thải khu/cụm cn tập trung";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CHỈNH SỬA GIẤY PHÉP XẢ THẢI KHU/CỤM CÔNG NGHIỆP TẬP TRUNG" previousLink="/quan-ly-cap-phep/xa-thai-khu-cum-cong-nghiep-tap-trung" showHeadImage={true} layoutfull={true} />
