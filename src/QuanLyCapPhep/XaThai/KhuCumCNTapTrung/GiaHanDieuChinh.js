...
export default class QuanLyCapPhepGiaHanDieuChinhXaThaiKhuCumCNTapTrung extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Gia hạn/ điều chỉnh giấy phép xả thải khu/cụm cn tập trung";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ GIA HẠN, ĐIỀU CHỈNH GIẤY PHÉP XẢ THẢI KHU/CỤM CÔNG NGHIỆP TẬP TRUNG" previousLink="/quan-ly-cap-phep/xa-thai-khu-cum-cong-nghiep-tap-trung" showHeadImage={true} layoutfull={true} />
