...
export default class QuanLyCapPhepXaThaiKhuCumCNTapTrung extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Xả thải - khu/cụm công nghiệp tập trung";
    ...
    render(){        
            ...
            },
            {
                ...
                render: (text, record) => (
                    <div className="d-flex align-items-center justify-content-center">
                        <Link to={"/quan-ly-cap-phep/xa-thai-khu-cum-cong-nghiep-tap-trung/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP PHÉP XẢ THẢI KHU/ CỤM CÔNG NGHIỆP TẬP TRUNG" previousLink="/quan-ly-cap-phep" showHeadImage={true} layout48={true} />
