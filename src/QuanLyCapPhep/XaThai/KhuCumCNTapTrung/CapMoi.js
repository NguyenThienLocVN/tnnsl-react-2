...
export default class QuanLyCapPhepKhaiThacCapMoiNDD extends React.Component {
    ...
    componentDidMount(){
        document.title = "Cấp mới giấy phép xả thải khu/cụm cn tập trung";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CẤP MỚI GIẤY PHÉP XẢ THẢI KHU/CỤM CÔNG NGHIỆP TẬP TRUNG" previousLink="/quan-ly-cap-phep/xa-thai-khu-cum-cong-nghiep-tap-trung" showHeadImage={true} layoutfull={true} />
