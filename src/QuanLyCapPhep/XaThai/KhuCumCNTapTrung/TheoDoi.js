...
export default class QuanLyCapPhepKhaiThacTheoDoiGiayPhepNDD extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="THÔNG TIN THEO DÕI CÔNG TRÌNH SAU CẤP PHÉP XẢ THẢI KHU/ CỤM CÔNG NGHIỆP TẬP TRUNG" previousLink="/quan-ly-cap-phep/xa-thai-khu-cum-cong-nghiep-tap-trung/quan-ly-cap-moi" showHeadImage={true} layoutfull={true} />
