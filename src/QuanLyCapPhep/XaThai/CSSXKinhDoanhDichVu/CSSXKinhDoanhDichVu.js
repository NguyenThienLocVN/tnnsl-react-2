...
export default class QuanLyCapPhepXaThaiCSSXKinhDoanhDichVu extends React.Component {
    ...
    componentDidMount(){
        document.title = "Xả thải - CSSX kinh doanh dịch vụ";
    ...
    render(){        
            ...
            },
            {
                ...
                render: (text, record) => (
                    <div className="d-flex align-items-center justify-content-center">
                        <Link to={"/quan-ly-cap-phep/xa-thai-cssx-kinh-doanh-dich-vu/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP PHÉP XẢ THẢI CSSX KINH DOANH DỊCH VỤ" previousLink="/quan-ly-cap-phep" showHeadImage={true} layout48={true} />
