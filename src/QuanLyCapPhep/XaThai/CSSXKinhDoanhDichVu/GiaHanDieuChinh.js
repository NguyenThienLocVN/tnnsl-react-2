...
export default class QuanLyCapPhepGiaHanDieuChinhXaThaiCSSXKinhDoanhDichVu extends React.Component {
    ...
    componentDidMount(){
        document.title = "Gia hạn/ điều chỉnh giấy phép xả thải CSSX kinh doanh dịch vụ";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ GIA HẠN, ĐIỀU CHỈNH GIẤY PHÉP XẢ THẢI CSSX KINH DOANH DỊCH VỤ" previousLink="/quan-ly-cap-phep/xa-thai-cssx-kinh-doanh-dich-vu" showHeadImage={true} layoutfull={true} />
