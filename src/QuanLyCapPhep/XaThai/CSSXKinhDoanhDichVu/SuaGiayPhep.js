...
export default class QuanLyCapPhepKhaiThacCapMoiNDD extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CHỈNH SỬA GIẤY PHÉP XẢ THẢI CSSX KINH DOANH DỊCH VỤ" previousLink="/quan-ly-cap-phep/xa-thai-cssx-kinh-doanh-dich-vu" showHeadImage={true} layoutfull={true} />
