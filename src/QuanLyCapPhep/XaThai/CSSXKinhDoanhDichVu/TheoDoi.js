...
export default class QuanLyCapPhepKhaiThacTheoDoiGiayPhepNDD extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="THÔNG TIN THEO DÕI CÔNG TRÌNH SAU CẤP PHÉP XẢ THẢI CSSX KINH DOAH DỊCH VỤ" previousLink="/quan-ly-cap-phep/xa-thai-cssx-kinh-doanh-dich-vu/quan-ly-cap-moi" showHeadImage={true} layoutfull={true} />
