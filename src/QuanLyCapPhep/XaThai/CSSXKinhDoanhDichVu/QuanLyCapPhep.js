...
export default class QuanLyCapPhepXaThaiCSSXKinhDoanhDichVu extends React.Component {
    ...
    componentDidMount(){
        document.title = "Quản lý cấp mới giấy phép xả thải";
    ...
    render(){
                ...
                render: (text, record, i) => (
                    <>
                        <div className="d-flex">
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-cssx-kinh-doanh-dich-vu/theo-doi/"+record.id} title="Theo Dõi"><EyeOutlined /></Link>
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-cssx-kinh-doanh-dich-vu/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP MỚI GIẤY PHÉP XẢ THẢI CSSX KINH DOANH DỊCH VỤ" previousLink="/quan-ly-cap-phep/xa-thai-cssx-kinh-doanh-dich-vu/" showHeadImage={true} layoutfull={true} />
