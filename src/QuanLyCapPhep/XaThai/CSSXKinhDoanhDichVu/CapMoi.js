...
export default class QuanLyCapPhepXaThaiCSSXKinhDoanhDichVu extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Cấp mới giấy phép xả thải CSSX kinh doanh dịch vụ";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CẤP MỚI GIẤY PHÉP XẢ THẢI CSSX KINH DOANH DỊCH VỤ" previousLink="/quan-ly-cap-phep/xa-thai-cssx-kinh-doanh-dich-vu" showHeadImage={true} layoutfull={true} />
