...
export default class QuanLyCapPhepSuaGiayPhepXaThaiKhuDanCu extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Sửa giấy phép xả thải khu dân cư";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CHỈNH SỬA GIẤY PHÉP XẢ THẢI KHU DÂN CƯ/ LÀNG NGHỀ" previousLink="/quan-ly-cap-phep/xa-thai-khu-dan-cu" showHeadImage={true} layoutfull={true} />
