...
export default class QuanLyCapPhepXaThaiKhuDanCu extends React.Component {
    ...
    componentDidMount(){
        document.title = "Xả thải - khu dân cư";
    ...
    render(){        
            ...
            },
            {
                ...
                render: (text, record) => (
                    <div className="d-flex align-items-center justify-content-center">
                        <Link to={"/quan-ly-cap-phep/xa-thai-khu-dan-cu/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP PHÉP XẢ THẢI KHU DÂN CƯ/ LÀNG NGHỀ" previousLink="/quan-ly-cap-phep" showHeadImage={true} layout48={true} />
