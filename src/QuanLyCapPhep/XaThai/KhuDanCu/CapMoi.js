...
export default class QuanLyCapPhepCapMoiXaThaiKhuDanCu extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Cấp mới giấy phép xả thải khu dân cư";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CẤP MỚI GIẤY PHÉP XẢ THẢI KHU DÂN CƯ/ LÀNG NGHỀ" previousLink="/quan-ly-cap-phep/xa-thai-khu-dan-cu" showHeadImage={true} layoutfull={true} />
