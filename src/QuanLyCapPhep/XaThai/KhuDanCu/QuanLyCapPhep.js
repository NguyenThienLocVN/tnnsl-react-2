...
export default class QuanLyCapPhepXaThaiKhuDanCu extends React.Component {
    ...
    render(){
                ...
                render: (text, record, i) => (
                    <>
                        <div className="d-flex">
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-khu-dan-cu/theo-doi/"+record.id} title="Theo Dõi"><EyeOutlined /></Link>
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/xa-thai-khu-dan-cu/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP MỚI GIẤY PHÉP XẢ THẢI KHU DÂN CƯ/ LÀNG NGHỀ" previousLink="/quan-ly-cap-phep/xa-thai-khu-dan-cu/" showHeadImage={true} layoutfull={true} />
