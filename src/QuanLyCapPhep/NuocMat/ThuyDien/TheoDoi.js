...
export default class QuanLyCapPhepTheoDoiGiayPhepNuocMatThuyDien extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="THÔNG TIN THEO DÕI CÔNG TRÌNH SAU CẤP PHÉP KHAI THAC SỬ DỤNG NƯỚC MẶT CÔNG TRÌNH THỦY ĐIỆN" previousLink="/quan-ly-cap-phep/nuoc-mat/thuy-dien/quan-ly-cap-moi" showHeadImage={true} layoutfull={true} />
