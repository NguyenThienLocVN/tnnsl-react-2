                ...
                <div className="col-10 py-2 m-auto row m-0 justify-content-center text-center">
                    ...
                    <div className="col-12 py-1 mt-4 d-flex justify-content-center text-center border-top border-bottom">
                        <div className="col-9 text-start p-0">
                            ...
                            <p className="font-18 m-0 fw-bold text-danger">{this.state.countLicense.allgp} / {this.state.countLicense.allgp}</p>
                        </div>
                    ...
                    <div className="col-12 py-1 d-flex justify-content-center text-center border-bottom">
                        <div className="col-9 text-start p-0">
                            ...
                            <p className="font-18 m-0 fw-bold text-danger">{this.state.countLicense.allgp - this.state.countLicense.chua_phe_duyet} / {this.state.countLicense.allgp}</p>
                        </div>
                    ...
                    <div className="col-12 py-1 d-flex justify-content-center text-center border-bottom">
                        <div className="col-9 text-start p-0">
                            ...
                            <p className="font-18 m-0 fw-bold text-danger">{this.state.countLicense.sap_het_hieu_luc} / {this.state.countLicense.allgp}</p>
                        </div>
                    ...
                    <div className="col-12 py-1 d-flex justify-content-center text-center border-bottom">
                        <div className="col-9 text-start p-0">
                            ...
                            <p className="font-18 m-0 fw-bold text-danger">{this.state.countLicense.het_hieu_luc} / {this.state.countLicense.allgp}</p>
                        </div>
                    ...
                    <div className="col-12 py-1 d-flex justify-content-center text-center border-bottom">
                        <div className="col-9 text-start p-0">
                            ...
                            <p className="font-18 m-0 fw-bold text-danger"> {this.state.countLicense.chua_phe_duyet} / {this.state.countLicense.allgp}</p>
                        </div>
