...
const user = getUser();
export default class QuanLyCapPhepQuanLyCapMoiNuocMatCongTrinhKhac extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Quản lý cấp mới giấy phép nước mặt - công trình khác";
    ...
    render(){
                ...
                render: (text, record, i) => (
                    <>
                        <div className="d-flex">
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/nuoc-mat/thuy-dien/theo-doi/"+record.id} title="Theo Dõi"><EyeOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP MỚI GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH KHÁC" previousLink="/quan-ly-cap-phep/nuoc-mat/cong-trinh-khac" showHeadImage={true} layoutfull={true} />
