...
export default class QuanLyCapPhepSuaGiayPhepNuocMatCongTrinhKhac extends React.Component {
    ...
    componentDidMount(){
        document.title = "Chỉnh sửa giấy phép khai thác nước mặt - công trình khác";
    ...
    render(){
        ...
        return(
			<div className="p-0">
                <Header headTitle="CHỈNH SỬA GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH KHÁC" previousLink="/quan-ly-cap-phep/nuoc-mat/cong-trinh-khac" showHeadImage={true} layoutfull={true} />
