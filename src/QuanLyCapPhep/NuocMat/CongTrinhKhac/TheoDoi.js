...
export default class QuanLyCapPhepTheoDoiGiayPhepNuocMatThuyDien extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="THÔNG TIN THEO DÕI CÔNG TRÌNH SAU CẤP PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CÔNG TRÌNH KHÁC" previousLink="/quan-ly-cap-phep/nuoc-mat/cong-trinh-khac/quan-ly-cap-moi" showHeadImage={true} layoutfull={true} />
