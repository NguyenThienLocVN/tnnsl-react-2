...
export default class QuanLyCapPhepCapMoiNuocMatCongTrinhKhac extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Cấp mới giấy phép khai thác nước mặt - công trình khác";
    }
    ...
    render(){
        return(
			...
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CẤP MỚI GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH KHÁC" previousLink="/quan-ly-cap-phep/nuoc-mat/cong-trinh-khac" showHeadImage={true} layoutfull={true} />
