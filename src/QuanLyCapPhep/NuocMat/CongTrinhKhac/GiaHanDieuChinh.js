...
export default class QuanLyCapPhepGiaHanDieuChinhNuocMatCongTrinhKhac extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ ĐỀ NGHỊ GIA HẠN/ ĐIỀU CHỈNH GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH KHÁC" previousLink="/quan-ly-cap-phep/nuoc-mat/cong-trinh-khac" showHeadImage={true} layoutfull={true} />
