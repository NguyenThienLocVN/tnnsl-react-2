...
export default class QuanLyCapPhepNuocMatCongTrinhKhac extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    render(){        
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP PHÉP CÔNG TRÌNH KHÁC" previousLink="/quan-ly-cap-phep" showHeadImage={true} layout48={true} />
