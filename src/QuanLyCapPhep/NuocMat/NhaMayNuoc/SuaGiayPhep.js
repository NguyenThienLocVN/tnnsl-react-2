...
export default class QuanLyCapPhepCapMoiNuocMatTramBom extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CHỈNH SỬA GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH NHÀ MÁY NƯỚC" previousLink="/quan-ly-cap-phep/nuoc-mat/nha-may-nuoc" showHeadImage={true} layoutfull={true} />
