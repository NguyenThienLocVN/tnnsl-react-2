...
export default class QuanLyCapPhepGiaHanDieuChinhNuocMatTramBom extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Cấp mới giấy phép nước mặt - hồ chứa";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ GIA HẠN/ ĐIỀU CHỈNH GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH TRẠM CẤP NƯỚC" previousLink="/quan-ly-cap-phep/nuoc-mat/tram-cap-nuoc" showHeadImage={true} layoutfull={true} />
                    ...
                    <div className="menu-home col-12 p-0 col-lg-9 discharge-water">
                        <form className="needs-validation" onSubmit={this.submitHandler} noValidate>
                            ...
                            <div className="pb-4 text-center col-sm-12">
                                <hr />
                                <button type="submit" className="btn btn-primary mx-2 fw-bold font-14">GỬI YÊU GIA HẠN/ ĐIỀU CHỈNH GIẤY PHÉP</button>
                            </div>
                        </form>
                    </div>
                </main>
