...
export default class QuanLyCapPhepCapMoiNuocMatTramBom extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CHỈNH SỬA GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH TRẠM CẤP NƯỚC" previousLink="/quan-ly-cap-phep/nuoc-mat/tram-cap-nuoc" showHeadImage={true} layoutfull={true} />
