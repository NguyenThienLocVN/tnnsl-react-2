...
export default class QuanLyCapPhepTheoDoiGiayPhepNuocMatTramBom extends React.Component {
    ...
    render(){
                ...
                render: (text, record, i) => (
                    <>
                        <div className="d-flex">
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/nuoc-mat/tram-cap-nuoc/theo-doi/"+record.id} title="Theo Dõi"><EyeOutlined /></Link>
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/nuoc-mat/tram-cap-nuoc/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP MỚI GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH TRẠM CẤP NƯỚC" previousLink="/quan-ly-cap-phep/nuoc-mat/tram-cap-nuoc" showHeadImage={true} layoutfull={true} />
