...
export default class QuanLyCapPhepNuocMatThongTinXemThongTinCongTrinh extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
          mode: 'top',
                    ...
                    <div className="col-lg-12 px-0 row mx-0">
                        <div className="col-lg-2    ">
                            <nav className="nav flex-column nav-pills pt-3">
                                ...
                                <Link to={"/quan-ly-cap-phep/nuoc-mat/xem-thong-tin-cong-trinh/"+this.props.match.params.id} className="nav-link text-dark border-bottom active">Thông tin công trình</Link>
                            ...
                            <div className="col-12 px-0">
                                ...
                                <div className="col-12 px-0">
                                    <div className="d-flex mx-0">
                                        ...
                                        <Link className="py-2 px-3 text-primary" to={"/quan-ly-cap-phep/nuoc-mat/xem-thong-tin-cong-trinh/chi-tiet/"+this.props.match.params.id}>Thông tin chi tiết</Link>
                                    </div>
