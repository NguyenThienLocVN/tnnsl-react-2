...
export default class QuanLyCapPhepCapMoiNuocMatTramBom extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CẤP MỚI GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH TRẠM BƠM" previousLink="/quan-ly-cap-phep/nuoc-mat/tram-bom" showHeadImage={true} layoutfull={true} />
