...
export default class QuanLyCapPhepTheoDoiGiayPhepNuocMatTramBom extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="THÔNG TIN THEO DÕI CÔNG TRÌNH SAU CẤP PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CÔNG TRÌNH TRẠM BƠM" previousLink="/quan-ly-cap-phep/nuoc-mat/tram-bom/quan-ly-cap-moi" showHeadImage={true} layoutfull={true} />
