...
export default class QuanLyCapPhepNuocMatCong extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ GIA HẠN/ ĐIỀU CHỈNH GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH CỐNG" previousLink="/quan-ly-cap-phep/nuoc-mat/cong" showHeadImage={true} layoutfull={true} />
                    ...
                    <div className="menu-home col-12 p-0 col-lg-9 discharge-water">
                        <form className="needs-validation" onSubmit={this.submitHandler} noValidate>
                                        ...
                                        <table className="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th className="text-center align-middle">Chiều cao cống (m)</th>
                                                        <th className="text-center align-middle">Chiều rộng cống (m)</th>
                                                        <th className="text-center align-middle">Đường kính cống (m)</th>
                                                        <th className="text-center align-middle">Chiều dài cống (m)</th>
                                                        <th className="text-center align-middle">Cao trình đáy cống (m)</th>
                                                        <th className="text-center align-middle">Diện tích thiết kế (ha)</th>
                                                        <th className="text-center align-middle">Diện tích thực tế (ha)</th>
                                                        <th className="text-center align-middle">Số cống</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                            ...
                            <div className="pb-4 text-center col-sm-12">
                                <hr />
                                <button type="submit" className="btn btn-primary mx-2 fw-bold font-14">GỬI YÊU GIA HẠN/ ĐIỀU CHỈNH MỚI GIẤY PHÉP</button>
                            </div>
                        </form>
                    </div>
                </main>
