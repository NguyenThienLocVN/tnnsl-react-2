...
const user = getUser();
export default class QuanLyCapPhepQuanLyCapMoiNuocMatCong extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    render(){
                ...
                render: (text, record, i) => (
                    <>
                        <div className="d-flex">
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/nuoc-mat/cong/theo-doi/"+record.id} title="Theo Dõi"><EyeOutlined /></Link>
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/nuoc-mat/cong/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP MỚI GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH ĐẬP THỦY LỢI" previousLink="/quan-ly-cap-phep/nuoc-mat/cong" showHeadImage={true} layoutfull={true} />
