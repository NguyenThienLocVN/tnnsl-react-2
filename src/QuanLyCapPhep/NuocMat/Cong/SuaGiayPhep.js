...
export default class QuanLyCapPhepNuocMatCong extends React.Component {
    ...
    componentDidMount(){
        document.title = "Cấp mới giấy phép nước mặt - cống";
    }
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CHỈNH SỬA GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH CỐNG" previousLink="/quan-ly-cap-phep/nuoc-mat/cong" showHeadImage={true} layoutfull={true} />
