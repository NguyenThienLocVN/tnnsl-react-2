...
export default class QuanLyCapPhepTheoDoiGiayPhepNuocMatDapThuyLoi extends React.Component {

    render(){
        return(
			<div className="p-0">
                <Header headTitle="THÔNG TIN THEO DÕI CÔNG TRÌNH SAU CẤP PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CÔNG TRÌNH ĐẬP THỦY LỢI" previousLink="/quan-ly-cap-phep/nuoc-mat/dap-thuy-loi/quan-ly-cap-moi" showHeadImage={true} layoutfull={true} />
