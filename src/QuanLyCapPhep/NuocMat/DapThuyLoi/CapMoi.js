...
export default class QuanLyCapPhepNuocMatDapThuyLoi extends React.Component {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ CẤP MỚI GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH ĐẬP THỦY LỢI" previousLink="/quan-ly-cap-phep/nuoc-mat/dap-thuy-loi" showHeadImage={true} layoutfull={true} />
