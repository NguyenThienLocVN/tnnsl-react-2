...
export default class QuanLyCapPhepTheoDoiGiayPhepNuocMatHoChua extends React.Component {

    render(){
        return(
			<div className="p-0">
                <Header headTitle="THÔNG TIN THEO DÕI CÔNG TRÌNH SAU CẤP PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CÔNG TRÌNH HỒ CHỨA" previousLink="/quan-ly-cap-phep/nuoc-mat/ho-chua/quan-ly-cap-moi" showHeadImage={true} layoutfull={true} />
