...
const user = getUser();
export default class QuanLyCapPhepQuanLyCapMoiNuocMatHoChua extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Quản lý cấp mới giấy phép nước mặt - Hồ chứa";
    ...
    render(){
                ...
                render: (text, record, i) => (
                    <>
                        <div className="d-flex">
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/nuoc-mat/ho-chua/theo-doi/"+record.id} title="Theo Dõi"><EyeOutlined /></Link>
                            <Link className="btn text-primary" to={"/quan-ly-cap-phep/nuoc-mat/ho-chua/chinh-sua/"+record.id} title="Chỉnh Sửa"><EditOutlined /></Link>
        ...
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP MỚI GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH HỒ CHỨA" previousLink="/quan-ly-cap-phep/nuoc-mat/ho-chua" showHeadImage={true} layoutfull={true} />
