...
export default class QuanLyCapPhepSuaGiayPhepNuocMatHoChua extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="ĐỀ NGHỊ SỬA CHỮA GIẤY PHÉP KHAI THÁC SỬ DỤNG NƯỚC MẶT CHO CÔNG TRÌNH HỒ CHỨA" previousLink="/quan-ly-cap-phep/nuoc-mat/ho-chua" showHeadImage={true} layoutfull={true} />
