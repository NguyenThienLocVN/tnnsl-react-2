        ...
        <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="ky_hieu_ct">Ký hiêu CT</label>
                    <input type="text" className="form-control font-13" id="ky_hieu_ct" placeholder="Ký hiêu CT" />
                </div>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="toa_do_x_ct">Tọa độ X</label>
                    <input type="text" className="form-control font-13" id="toa_do_x_ct" placeholder="Tọa độ X" />
                </div>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="toa_do_y_ct">Tọa Độ Y</label>
  ...
  function LuuTheoLuongMucDichKTSD() {
    ...
    return (
        ...
        <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="muc_dich">Mục đích</label>
                    <input type="text" className="form-control font-13" id="muc_dich" placeholder="Mục đích" />
                </div>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="luu_luong">Lưu lượng</label>
                    <input type="text" className="form-control font-13" id="luu_luong" placeholder="Lưu lượng" />
                </div>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="dv_do">Đơn vị đo</label>
...
function HangMucCongTrinh() {
    ...
    return (
        ...
        <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="ten_hang_muc_ct">Tên hạng mục</label>
                    <input type="text" className="form-control font-13" id="ten_hang_muc_ct" placeholder="Ký hiêu CT" />
                </div>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="toa_do_x_hang_muc_ct">Tọa độ X</label>
                    <input type="text" className="form-control font-13" id="toa_do_x_hang_muc_ct" placeholder="Tọa độ X" />
                </div>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="toa_do_y_hang_muc_ct">Tọa Độ Y</label>
                    <input type="text" className="form-control font-13" id="toa_do_y_hang_muc_ct" placeholder="Tọa Độ Y" />
                </div>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="muc_dich_hang_muc_vt">Mục đích</label>
                ...
                <>
                   <div className="exploit-surfacewater">
                        <div className="row pb-2 mx-0">
                            <label htmlFor="construction_name" className="col-sm-12 col-form-label fw-bold font-13">Tên công trình</label>
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="construction_type" className="col-sm-12 col-form-label fw-bold font-13"> Ký hiệu công trình </label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="contruction_address" className="col-sm-12 col-form-label fw-bold font-13"> Địa điểm công trình</label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 px09 mx-0">
                            <div className="col-sm-6 pb-2 px-0 mx-0">
                                <label htmlFor="huyen" className="col-sm-12 col-form-label fw-bold font-13">Huyện </label>
                                <div className="col-sm-12">
                                    <div className="form-group">
                            ...
                            <div className="col-sm-6 pb-2 px-0 mx-0">
                                <label htmlFor="xa" className="col-sm-12 col-form-label fw-bold font-13">Xã </label>
                                <div className="col-sm-12">
                                    <div className="form-group">
                        ...
                        <div className="pb-2 px-0 mx-0">
                            <label htmlFor="muc_dich_sd" className="col-sm-12 col-form-label fw-bold font-13">Mục đích sử dụng </label>
                            <div className="col-sm-12">
                        ...
                        <div className="pb-2 px-0 mx-0">
                            <label htmlFor="nguon_nuoc_kt_sd" className="col-sm-12 col-form-label fw-bold font-13">Nguồn nước khai thác sử dụng</label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="thuoc_song" className="col-sm-12 col-form-label fw-bold font-13"> Thuộc sông</label>
                            <div className="col-sm-12">
                                <input type="text" className="form-control form-control-sm" id="thuoc_song" name="thuoc_song" placeholder=" -- Thuộc sông --" />
                            </div>
                        </div>
                        <div className="row pb-2 mx-0">
                            <label htmlFor="thuoc_luu_vuc_song" className="col-sm-12 col-form-label fw-bold font-13"> Thuộc lưu vực sông</label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="che_do_kt" className="col-sm-12 col-form-label fw-bold font-13"> Chế độ khai thác</label>
                            <div className="col-sm-12">
                        ...
                        <div className="pb-2 mx-0 px-0">
                            <label htmlFor="luong_nuoc_kt_sd" className="col-sm-12 col-form-label fw-bold font-13"> Lượng nước khai thác, sử dụng</label>
                            <div className="col-sm-12">
                        ...
                        <div className="pb-2 mx-0">
                            <label htmlFor="phuong_thuc_kt" className="col-sm-12 col-form-label fw-bold font-13"> Phương thức khai thác</label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="nam_sd" className="col-sm-12 col-form-label fw-bold font-13"> Năm sử dụng</label>
                            <div className="col-sm-12">
                                <input type="text" className="form-control form-control-sm" id="nam_sd" name="nam_sd" placeholder=" -- Năm sử dụng --" />
                            </div>
                        </div>
                        <div className="pb-2 mx-0">
                            <label htmlFor="ghi_chu_ct" className="col-sm-12 col-form-label fw-bold font-13"> Ghi chú CT</label>
                            <div className="col-sm-12">
                    ...
                    <div className="exploit-surfacewater mb-2">
                        <div className="row pb-2 mx-0">
                            <label htmlFor="cong_suat_lap_may" className="col-sm-12 col-form-label fw-bold font-13"> Công suất lắp máy(MW)</label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="q_max_thuy_dien" className="col-sm-12 col-form-label fw-bold font-13"> Lưu lượng lớn nhất qua nhà máy thủy điện (m3/s)</label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="q_xa_tt" className="col-sm-12 col-form-label fw-bold font-13"> Lưu lượng xả dòng chảy tối thiểu (m3/s)</label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="dung_tich_huu_ich" className="col-sm-12 col-form-label fw-bold font-13"> Dung tích hữu ích (triệu m3)</label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="dung_tich_toan_bo" className="col-sm-12 col-form-label fw-bold font-13"> Dung tích toàn bộ (triệu m3)</label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="muc_nuoc_chet" className="col-sm-12 col-form-label fw-bold font-13"> Mực nước chết (m)</label>
                            <div className="col-sm-12">
                                <input type="text" className="form-control form-control-sm" id="muc_nuoc_chet" name="muc_nuoc_chet" placeholder=" -- Mực nước chết (m) --" />
                            </div>
                        </div>
                        <div className="row pb-2 mx-0">
                            <label htmlFor="muc_nuoc_dang_bt" className="col-sm-12 col-form-label fw-bold font-13"> Mực nước dâng bình thường (m)</label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="muc_nuoc_max_truoc_lu" className="col-sm-12 col-form-label fw-bold font-13"> Mực nước cao nhất trước lũ (m)</label>
                            <div className="col-sm-12">
                        ...
                        <div className="row pb-2 mx-0">
                            <label htmlFor="muc_nuoc_don_lu" className="col-sm-12 col-form-label fw-bold font-13"> Mực nước đón lũ (m)</label>
                            <div className="col-sm-12">
