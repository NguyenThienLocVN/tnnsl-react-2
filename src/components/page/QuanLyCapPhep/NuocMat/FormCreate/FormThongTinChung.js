        ...
        <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="ten_dot_tt">Tên đợt</label>
                    <input type="text" className="form-control font-13" id="ten_dot_tt" placeholder="Tên đợt thanh tra" />
                </div>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="ten_don_vi_tt">Tên đơn vị thực hiện</label>
                    <input type="text" className="form-control font-13" id="ten_don_vi_tt" placeholder="Tên đơn vị thực hiện" />
                </div>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="ten_truong_doan_tt">Tên trưởng đoàn</label>
                    <input type="text" className="form-control font-13" id="ten_truong_doan_tt" placeholder="Tên trưởng đoàn" />
                </div>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="nam_tt">Năm thực hiện</label>
  ...
  function TienCapQuyen() {
    ...
    return (
        ...
        <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="so_quyet_dinh">Số quyết định</label>
                    <input type="text" className="form-control font-13" id="so_quyet_dinh" placeholder="Số quyết định" />
                </div>
                <div className="form-group">
                    <label className="font-13 fw-bold" htmlFor="tong_tien">Tổng tiền</label>
                ...
                <>
                    <div className="exploit-surfacewater">
                        <div className="pb-2 mx-0">
                            <label htmlFor="organization_name" className="col-sm-12 col-form-label fw-bold font-13">Tên tổ chức/cá nhân  được CP</label>
                        ...
                        <div className="pb-2 mx-0">
                            <label htmlFor="organization_address" className="col-sm-12 col-form-label fw-bold font-13"> Địa chỉ tổ chức/cá nhân được CP </label>
                            <div className="col-sm-12">
                        ...
                        <div className="pb-2 mx-0">
                            <label htmlFor="license_num" className="col-sm-12 col-form-label fw-bold font-13"> Số GP </label>
                            <div className="col-sm-12">
                                <input type="text" className="form-control form-control-sm font-13" id="license_num" name="license_num" placeholder=" -- Số GP --" />
                            </div>
                        </div>
                        <div className="pb-2 mx-0">
                            <label htmlFor="license_name" className="col-sm-12 col-form-label fw-bold font-13"> Tên văn bản GP</label>
                            <div className="col-sm-12">
                                <input type="text" className="form-control form-control-sm font-13" id="license_name" name="license_name" placeholder=" -- Tên văn bản --" />
                            </div>
                        </div>
                        <div className="pb-2 mx-0">
                            <label htmlFor="co_quan_cp" className="col-sm-12 col-form-label fw-bold font-13"> Cơ quan cấp phép </label>
                            <div className="col-sm-12">
                        ...
                        <div className="pb-2 mx-0">
                            <label htmlFor="dv_tham_dinh" className="col-sm-12 col-form-label fw-bold font-13"> Đơn vị thẩm định </label>
                            <div className="col-sm-12">
                        ...
                        <div className="row mx-0">
                            <div className="pb-2 mx-0 col-sm-6 px-0">
                                <label htmlFor="cap_tham_quyen" className="col-sm-12 col-form-label fw-bold font-13">Cấp thẩm quyền </label>
                                <div className="col-sm-12">
                                    <div className="form-group">
                            ...
                            <div className="pb-2 mx-0 col-sm-6 px-0">
                                <label htmlFor="license_type" className="col-sm-12 col-form-label fw-bold font-13">Loại hình GP </label>
                                <div className="col-sm-12">
                                    <div className="form-group">
                        ...
                        <div className="row m-0">
                            <div className="col-sm-4 px-0 pb-2 mx-0">
                                <label htmlFor="nguoi_ky_gp" className="col-sm-12 col-form-label fw-bold font-13"> Người ký GP </label>
                                <div className="col-sm-12">
                                    <input type="text" className="form-control form-control-sm font-13" id="nguoi_ky_gp" name="nguoi_ky_gp" placeholder=" -- Người ký GP --" />
                                </div>
                            </div>
                            <div className="col-sm-4 px-0 pb-2 mx-0">
                                <label htmlFor="chuc_vu_nguoi_ky_gp" className="col-sm-12 col-form-label fw-bold font-13"> Chức vụ </label>
                                <div className="col-sm-12">
                            ...
                            <div className="col-sm-4 px-0 pb-2 mx-0">
                                <label htmlFor="ngay_ky_gp" className="col-sm-12 col-form-label fw-bold font-13">Ngày ký </label>
                                <div className="col-sm-12">
                        ...
                        <div className="row m-0">
                            <div className="col-sm-6 pb-2 px-0 px-0 mx-0">
                                <label htmlFor="ngay_hieu_luc_dp" className="col-sm-12 col-form-label fw-bold font-13">Ngày hiệu lực GP</label>
                                <div className="col-sm-12">
                            ...
                            <div className="col-sm-6 pb-2 px-0 mx-0">
                                <label htmlFor="han_hieu_luc_dp" className="col-sm-12 col-form-label fw-bold font-13">Hạn hiệu lực GP </label>
                                <div className="col-sm-12">
                        ...
                        <div className="pb-2 mx-0">
                            <label htmlFor="noi_nhan_gp" className="col-sm-12 col-form-label fw-bold font-13">Nơi nhận GP </label>
                            <div className="col-sm-12">
                                <input type="text" className="form-control form-control-sm font-13" id="noi_nhan_gp" name="noi_nhan_gp" placeholder=" -- Nơi nhận GP --" />
                            </div>
                        </div>
                        <div className="pb-2 mx-0">
                            <label htmlFor="ghi_chu_gp" className="col-sm-12 col-form-label fw-bold font-13">Ghi chú GP</label>
                            <div className="col-sm-12">
