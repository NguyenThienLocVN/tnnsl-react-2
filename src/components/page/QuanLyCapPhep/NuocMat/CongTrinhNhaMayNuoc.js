...
export default class QuanLyCapPhepNuocMatCongTrinhNhaMayNuoc extends React.Component {
    constructor(props)
    {
        super(props)
        this.state = {
    ...
    componentDidMount(){
        document.title = "Công trình nhà máy nước";
        ...
        trackPromise(
            ...
            .then((response) => {
                ...
                {
                    this.setState({
                        DataCongTrinhNhaMayNuoc: response.data.gp_nhamaynuoc.data,
                    });
                }
            })
            .catch((error) => {
    ...
    render(){
        return(
			<div className="p-0">
                <Header headTitle="QUẢN LÝ CẤP PHÉP CÔNG TRÌNH NHÀ MÁY NƯỚC" previousLink="/quan-ly-cap-phep" showHeadImage={true} layout48={true} />
                <main className="d-flex flex-column flex-lg-row">
                    <div className="col-12 col-lg-3 px-0 menu-home discharge-water text-center">
                        <div className="col-12 px-2">
                            
                            <div className="col-10 py-2 m-auto d-flex justify-content-center text-center">
                                <img src={process.env.PUBLIC_URL + '/images/QUAN_LY_CAP_PHEP/CONG_TRINH/nhamaynuoc.jpg'} className="p-0 hydroelectric-icon rounded-circle border border-secondary my-auto mx-3" alt="dap-thuy-dien" />
                                <div className="col-6 text-center p-0">
                                    <p className="fw-bold mb-1">Tổng số công trình nhà máy nước </p>
                            ...
                            <div className="col-12 py-1 mt-4 d-flex justify-content-center text-center border-top border-bottom">
                                ...
                                <img src={process.env.PUBLIC_URL + '/images/QUAN_LY_CAP_PHEP/CONG_TRINH/nhamaynuoc.jpg'} className="p-0 hydroelectric-sub-icon border-secondary my-auto mx-3" alt="dap-thuy-dien" />
                            </div>
                            ...
                            <div className="col-12 p-0 ">
                                ...
                                <div className="table-responsive">
                                    <table className="table table-sm table-bordered col-12 table-hover text-center">
                                        ...
                                        <tbody>
                                            {this.state.DataCongTrinhNhaMayNuoc.map((e, i) => {
                                                return (
                                                    <tr key={i}>
