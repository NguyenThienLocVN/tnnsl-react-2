      ...
      //HÀNG BẢNG 2    
          const columns = [
            ...
            //  },
              ...
              {
                title: () => {
                      return <span>Lưu lượng xả <br /> qua nhà máy(m3/s) </span>
                }, 
                    dataIndex: 'gp_xanhamay',
              ...
              {
                title: () => {
                      return <span>Lưu lượng xả <br /> qua tràn(m3/s) </span>
                }, 
                    dataIndex: 'gp_xanhamay',
            ...
            },
            {
                ...
                render: (text, record) => (
                    <>
                        <Link to={"/he-thong-giam-sat/dinh-ky-xa-tran-ho-nho/lich-su/"+record.view_history} className="text-center">Xem</Link>
                    </>
                ),
            },
          ];
