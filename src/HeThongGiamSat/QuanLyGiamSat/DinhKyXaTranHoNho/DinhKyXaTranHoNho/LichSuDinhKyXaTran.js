...
export default class HeThongGiamSatLichSuDinhKyXaTranHoNho extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT ĐỊNH KỲ LƯU LƯỢNG XẢ QUA TRÀN " previousLink="/he-thong-giam-sat/dinh-ky-xa-tran-ho-nho" showHeadImage={true} layoutfull={true} />
                    ...
                    <div className="col-12 col-lg-9 px-0 menu-home">
                        ...
                        <div className="col-12 row align-items-center my-1 px-0 mx-0">
                            <Tabs tabPosition="top" defaultActiveKey="1">
                                <TabPane tab="Giám sát định kỳ mực nước hồ thượng lưu " key="1">
                                    <GiamSatKetNoi />
                                </TabPane>
                                <TabPane tab="Giám sát định kỳ dòng chảy đến hồ" key="2">
                                    <GiamSatDuLieu />
                               </TabPane>
                               <TabPane tab="Giám sát định kỳ xả dòng chảy tối thiểu" key="3"> 
                                    <CameraGiamSat /> 
                                </TabPane> 
                                <TabPane tab="Giám sát định kỳ lưu lượng xả qua nhà máy" key="4">
                                    <NhatKyCanhBao /> 
                                </TabPane> 
                               <TabPane tab="Giám sát định kỳ lưu lượng xả qua tràn" key="5"> 
                                   <GiamSatXaTran /> 
                                </TabPane> 
                            </Tabs>
                        </div>
