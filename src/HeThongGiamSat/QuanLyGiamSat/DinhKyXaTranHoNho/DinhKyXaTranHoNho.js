...
export default class HeThongGiamSatDinhKyXaTranHoNho extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT ĐỊNH KỲ LƯU LƯỢNG XẢ QUA TRÀN " previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
