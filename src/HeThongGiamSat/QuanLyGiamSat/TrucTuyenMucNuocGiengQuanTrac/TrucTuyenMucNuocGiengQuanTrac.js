...
export default class HeThongGiamSatTrucTuyenMucNuocGiengQuanTrac extends React.Component {
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT TRỰC TUYẾN MỰC NƯỚC TRONG GIẾNG KHAI THÁC CỦA CÔNG TRÌNH KHAI THÁC NƯỚC DƯỚI ĐẤT" previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
