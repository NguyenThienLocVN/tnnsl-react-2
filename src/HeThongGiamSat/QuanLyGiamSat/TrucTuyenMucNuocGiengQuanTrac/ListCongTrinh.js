    ...
    render(){
        const dataSource = [
          ...
          const columns = [
            ...
            {
                title: () => {
                    return <span>Thời gian gửi <br /> dữ liệu </span>
                }, 
              ...
              {
                title: () => {
                    return <span>Mực nước <br /> trong giếng <br /> khai thác (m) </span>
                }, 
                    dataIndex: 'gp_mucnuocgiengKT',
                    
                key: 'gp_mucnuocgiengKT',
                width: 100,
            ...
            },
            {
                ...
                render: (text, record) => (
                    <>
                        <Link to={"/he-thong-giam-sat/truc-tuyen-muc-muoc-gieng-quan-trac/lich-su/"+record.view_history} className="text-center">Xem</Link>
                    </>
                ),
            },
          ];
