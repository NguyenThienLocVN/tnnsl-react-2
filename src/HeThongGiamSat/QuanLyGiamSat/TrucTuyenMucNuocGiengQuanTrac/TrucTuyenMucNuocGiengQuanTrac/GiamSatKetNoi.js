...
//import HeThongGiamSatTrucTuyenMucNuocGiengQuanTrac from './../TrucTuyenMucNuocGiengQuanTrac';

const { TabPane } = Tabs;


export default class HeThongGiamSatTrucTuyenMucNuocGiengQuanTrac extends React.Component {
    constructor(props){
        super(props)
        this.state = {
            activeModal: null,
 ...
 // HÀNG BẢNG 2
        const columnTram = [
            ...
            {
                title: () => {
                    return <span>Tầng chứa nước <br /> khai thác </span>
                } ,
                dataIndex: '',
                key: '',
            },
            {
                title: 'Mực nước trong giếng khai thác (m)',
                children: [
                    {
                      title: 'Mực nước',
                      dataIndex: '',
