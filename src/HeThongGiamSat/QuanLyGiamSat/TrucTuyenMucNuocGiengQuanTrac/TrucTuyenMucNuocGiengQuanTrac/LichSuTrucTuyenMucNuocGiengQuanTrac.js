...
export default class HeThongGiamSatLichSuTrucTuyenMucNuocGiengQuanTracN extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT TRỰC TUYẾN MỰC NƯỚC TRONG GIẾNG KHAI THÁC " previousLink="/he-thong-giam-sat/truc-tuyen-muc-muoc-gieng-quan-trac" showHeadImage={true} layoutfull={true} />
                    ...
                    <div className="col-12 col-lg-9 px-0 menu-home">
                        ...
                        <div className="col-12 row align-items-center my-1 px-0 mx-0">
                            <Tabs tabPosition="top" defaultActiveKey="1">
                                <TabPane tab="Giám sát mực nước trong giếng khai thác " key="1">
                                    <GiamSatKetNoi />
                                </TabPane>
                                {/* <TabPane tab="Giám sát mực nước hồ hạ lưu" key="2">
                                    <GiamSatDuLieu />
                               </TabPane>
