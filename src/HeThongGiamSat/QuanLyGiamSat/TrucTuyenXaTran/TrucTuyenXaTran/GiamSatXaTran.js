...
// hạng mục giám sát lưu lượng xả qua tràn
...
export default class GiamSatXaTran extends React.Component {
    constructor(props){
        super(props)
        this.state = {
            activeModal: null,
    ...
    render(){
        ...
        const columnTramMatKetNoi = [
            ...
            {
                title: () => { 
                    return <span>Lưu lượng <br /> xả qua nhà máy <br /> m3/s</span>
                } ,
            ...
            {
                title: () => { 
                    return <span>Lưu lượng <br /> xả qua tràn <br /> m3/s</span>
                } ,
