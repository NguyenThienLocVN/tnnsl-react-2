...
export default class HeThongGiamSatCameraXaDCTT extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT BẰNG CAMERA ĐỐI VỚI VIỆC VẬN HÀNH XẢ DÒNG CHẢY TỐI THIỂU" previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
