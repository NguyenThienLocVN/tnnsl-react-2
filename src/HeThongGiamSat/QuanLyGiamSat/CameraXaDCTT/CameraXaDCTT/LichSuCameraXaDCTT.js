...
export default class HeThongGiamSatLichSuCameraXaDCTT extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT BẰNG CAMERA ĐỐI VỚI VIỆC VẬN HÀNH XẢ DÒNG CHẢY TỐI THIỂU" previousLink="/he-thong-giam-sat/camera-van-hanh-xa-dctt" showHeadImage={true} layoutfull={true} />
