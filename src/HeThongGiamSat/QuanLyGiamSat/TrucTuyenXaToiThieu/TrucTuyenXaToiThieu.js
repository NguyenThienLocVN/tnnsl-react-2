...
export default class HeThongGiamSatTrucTuyenXaDongChayToiThieu extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT TRỰC TUYẾN LƯU LƯỢNG XẢ DUY TRÌ DÒNG CHẢY TỐI THIỂU" previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
