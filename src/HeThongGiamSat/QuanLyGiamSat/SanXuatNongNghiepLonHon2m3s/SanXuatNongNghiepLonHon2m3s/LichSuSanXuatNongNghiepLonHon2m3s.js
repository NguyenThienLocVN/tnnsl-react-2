...
export default class HeThongGiamSatLichSuSanXuatNongNghiepLonHon2m3s extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div className="pt-1 px-1">
                <Header headTitle="GIÁM SÁT HOẠT ĐỘNG KHAI THÁC, SỬ DỤNG NƯỚC ĐỐI VỚI CÔNG TRÌNH ĐỂ SẢN XUẤT NÔNG NGHIỆP, NUÔI TRỒNG THỦY SẢN > 2m3/s" previousLink="/he-thong-giam-sat/san-xuat-nong-nghiep" showHeadImage={true} layoutfull={true} />
