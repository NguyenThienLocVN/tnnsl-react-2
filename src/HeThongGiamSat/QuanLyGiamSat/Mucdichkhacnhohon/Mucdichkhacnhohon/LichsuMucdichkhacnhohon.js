...
export default class HeThongGiamSatLichSuMucdichkhacnhohon extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="GIÁM SÁT HOẠT ĐỘNG KHAI THÁC, SỬ DỤNG NƯỚC ĐỐI VỚI MỤC ĐÍCH KHÁC VỚI QUY MÔ NHỎ HƠN 50.000 m3/ngày đêm " previousLink="/he-thong-giam-sat/muc-dich-khac-lon-hon" showHeadImage={true} layoutfull={true} />
