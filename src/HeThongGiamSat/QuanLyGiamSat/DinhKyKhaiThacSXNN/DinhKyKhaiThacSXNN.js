...
// SỬA Ở ĐÂY
export default class HeThongGiamSatDinhKyKhaiThacSXNN extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="GIÁM SÁT ĐỊNH KỲ HOẠT ĐỘNG KHAI THÁC, SỬ DỤNG NƯỚC ĐỐI VỚI CÔNG TRÌNH ĐỂ SẢN XUẤT NÔNG NGHIỆP, NUÔI TRỒNG THỦY SẢN " previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
