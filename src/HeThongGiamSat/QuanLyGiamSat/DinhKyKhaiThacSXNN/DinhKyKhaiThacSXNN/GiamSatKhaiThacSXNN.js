...
export default class GiamSatKhaiThacSXNN extends React.Component {
    constructor(props){
        super(props)
        this.state = {
            activeModal: null,
    ...
    render(){
        ...
        // COLUMN LƯU LUONG KHAI THAC SU DUNG
        const columnTramMatKetNoi = [
            ...
            {
                title: () => { 
                    return <span>Lưu lượng cấp <br /> cho sinh hoạt / công nghiệp <br /> (m3/s)</span>
                },
                width: 50,
                dataIndex: '',
                key: '',
            ...
            {
                title: () => { 
                    return <span>Lưu lượng cấp <br /> cho nước tưới NN <br /> (m3/s)</span>
                } ,
            ...
            {
                title: () => { 
                    return <span>Lưu lượng cấp <br /> cho môi trường sinh thái <br /> (m3/s) </span>
                } ,
        ...
        const columnTramVuotNguong = [
            ...
            {
                title: () => { 
                    return <span>Lưu lượng cấp <br /> vượt ngưỡng SH/CN <br /> (m3/s)</span>
                },
                width: 50,
                dataIndex: '',
                key: '',
            ...
            {
                title: () => { 
                    return <span>Lưu lượng cho <br /> cấp nước tưới NN <br /> (m3/s)</span>
                } ,
            ...
            {
                title: () => { 
                    return <span>Lưu lượng cấp <br /> vượt ngưỡng NN <br /> (m3/s)</span>
                },
                width: 50,
                dataIndex: '',
                key: '',
            ...
            {
                title: () => { 
                    return <span>Lưu lượng cho <br /> môi trường sinh thái <br /> (m3/s) </span>
                } ,
            ...
            {
                title: () => { 
                    return <span>Lưu lượng cấp <br /> vượt ngưỡng MTST <br /> (m3/s)</span>
                },
                width: 50,
                dataIndex: '',
                key: '',
            ...
            <>
                ...
                <div className="table-responsive px-2">
                    <Tabs tabPosition="top" defaultActiveKey="1">
                        <TabPane tab="Lưu lượng khai thác sử dụng" key="1">
                            <div>
