...
export default class HeThongGiamSatDinhKyMucNuocGiengQuanTrac extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT ĐỊNH KỲ MỰC NƯỚC TRONG GIẾNG KHAI THÁC CỦA CÔNG TRÌNH KHAI THÁC NƯỚC DƯỚI ĐẤT" previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
