...
export default class HeThongGiamSatLichSuDinhKyMucNuocGiengQuanTrac extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT ĐỊNH KỲ MỰC NƯỚC TRONG GIẾNG KHAI THÁC " previousLink="/he-thong-giam-sat/dinh-ky-muc-muoc-gieng-quan-trac" showHeadImage={true} layoutfull={true} />
