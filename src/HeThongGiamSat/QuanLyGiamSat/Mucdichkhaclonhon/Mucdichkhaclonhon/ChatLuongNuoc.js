...
export default class ChatLuongNuoc extends React.Component {
    constructor(props){
        super(props)
        this.state = {
            activeModal: null,
    ...
    render(){
        ...
        const dataTram = [
            {
                key: '1',
                id: '1',
                quantrac_tentram: 'CHATLUONGNUOC SO 1',
                tram_kyhieu: '',
                tram_chiso: 'CLN',
                tram_thoigiannhan: '',
                tram_giatriquantrac: '',
        ...
        const columnTramMatKetNoi = [
            ...
            {
                title: () => (
                    <p className="text-center">Lưu lượng đến <br /> (m3/s) </p>
                ),
                dataIndex: '',
                key: '',
            },
            ...
            {
                title: () => (
                    <p className="text-center">Q khai thác <br /> (m3/s) </p>
                ),
                dataIndex: '',
                key: '',
            },
        ...
        const columnTramVuotNguong = [
            ...
            {
                title: 'Giá trị QT hiện tại (m3/s)',
                dataIndex: '',
                key: '',
            },
            {
            ...
            <>
                ...
                <div className="table-responsive px-2">
                    <Tabs tabPosition="top" defaultActiveKey="1">
                        <TabPane tab="Chất lượng nước trong quá trình khai thác theo quy định" key="1">
                            <div>
