...
export default class HeThongGiamSatXaThaiNhoHon extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT XẢ THẢI VÀO NGUỒN NƯỚC CÓ QUY MÔ NHỎ HƠN 3000 m3/ngày đêm " previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
