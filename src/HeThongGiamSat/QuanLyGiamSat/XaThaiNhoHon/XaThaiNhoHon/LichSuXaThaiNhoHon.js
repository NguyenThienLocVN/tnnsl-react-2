...
export default class HeThongGiamSatLichSuXaThaiNhoHon extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT XẢ THẢI VÀO NGUỒN NƯỚC CÓ QUY MÔ NHỎ HƠN 3000 m3/ngày đêm " previousLink="/he-thong-giam-sat/xa-thai-nho-hon-3000m3ngaydem" showHeadImage={true} layoutfull={true} />
