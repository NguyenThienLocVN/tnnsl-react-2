...
export default class TongHopVanHanh extends React.Component {
    ...
    render(){
        ...
        const columnTramMatKetNoi = [
            ...
            {
                title: () => (
                    <p className="text-center">Q xả qua <br /> nhà máy <br /> (m3/s) </p>
                ),
                dataIndex: '',
                key: '',
            },
            {
                title: () => (
                    <p className="text-center">Q xả tràn <br /> (m3/s) </p>
                ),
                dataIndex: '',
                key: '',
            },
            {
                title: () => (
                    <p className="text-center">Tổng <br /> lưu lượng xả <br /> (m3/s) </p>
                ),
                dataIndex: '',
                key: '',
            },
