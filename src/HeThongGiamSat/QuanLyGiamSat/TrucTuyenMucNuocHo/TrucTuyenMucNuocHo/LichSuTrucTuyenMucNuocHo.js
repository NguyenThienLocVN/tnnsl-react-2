...
export default class HeThongGiamSatLichSuTrucTuyenMucNuocHo extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT TRỰC TUYẾN MỰC NƯỚC HỒ CHỨA " previousLink="/he-thong-giam-sat/truc-tuyen-muc-nuoc-ho-chua" showHeadImage={true} layoutfull={true} />
