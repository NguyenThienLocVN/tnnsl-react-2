...
export default class HeThongGiamSatKhaiThacNuocDuoiDatLonHon extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div className="pt-1 px-1">
                <Header headTitle="GIÁM SÁT HOẠT ĐỘNG KHAI THÁC, SỬ DỤNG NƯỚC DƯỚI ĐẤT ĐỐI VỚI CÔNG TRÌNH CÓ QUY MÔ TỪ 3.000 m3/ngày đêm TRỞ LÊN" previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
