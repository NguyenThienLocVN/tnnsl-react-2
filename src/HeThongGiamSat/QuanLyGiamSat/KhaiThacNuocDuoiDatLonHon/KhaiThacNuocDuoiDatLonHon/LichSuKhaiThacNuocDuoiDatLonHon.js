...
export default class HeThongGiamSatLichSuKhaiThacNuocDuoiDatLonHon extends React.Component {
    ...
    render(){
        return(
            <div>
                <Header headTitle="GIÁM SÁT HOẠT ĐỘNG KHAI THÁC, SỬ DỤNG NƯỚC DƯỚI ĐẤT ĐỐI VỚI CÔNG TRÌNH CÓ QUY MÔ TỪ 3.000 m3/ngày đêm TRỞ LÊN" previousLink="/he-thong-giam-sat/khai-thac-nuoc-duoi-dat-lon-hon" showHeadImage={true} layoutfull={true} />
