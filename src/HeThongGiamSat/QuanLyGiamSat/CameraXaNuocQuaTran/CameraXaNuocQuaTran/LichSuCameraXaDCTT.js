...
export default class HeThongGiamSatLichSuCameraXaNuocQuaTran extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT BẰNG CAMERA ĐỐI VỚI VIỆC VẬN HÀNH XẢ NƯỚC QUA TRÀN" previousLink="/he-thong-giam-sat/camera-van-hanh-xa-nuoc-qua-tran" showHeadImage={true} layoutfull={true} />
                    ...
                    <div className="col-12 col-lg-9 px-0 menu-home">
                        ...
                        <div className="col-12 row align-items-center my-1 px-0 mx-0">
                            <Tabs tabPosition="top" defaultActiveKey="1">
                                ...
                                <TabPane tab="Camera giám sát" key="1">
                                    <CameraGiamSat />
                                </TabPane>
