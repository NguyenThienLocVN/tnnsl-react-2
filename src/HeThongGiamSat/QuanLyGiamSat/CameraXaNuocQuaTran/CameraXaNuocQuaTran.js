...
export default class HeThongGiamSatCameraXaNuocQuaTran extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT BẰNG CAMERA ĐỐI VỚI VIỆC VẬN HÀNH XẢ NƯỚC QUA TRÀN" previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
