...
export default class HeThongGiamSatXaThaiNuoiTrongThuySanLonHon extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT XẢ THẢI VÀO NGUỒN NƯỚC HOẠT ĐỘNG NUÔI TRỒNG THỦY SẢN CÓ QUY MÔ TỪ 30.000 m3/ngày đêm TRỞ LÊN" previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
