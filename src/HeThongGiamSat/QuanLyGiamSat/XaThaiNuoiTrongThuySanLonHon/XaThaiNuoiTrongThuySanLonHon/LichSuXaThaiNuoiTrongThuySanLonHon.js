...
export default class HeThongGiamSatLichSuNuoiTrongThuySanLonHon extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT XẢ THẢI VÀO NGUỒN NƯỚC HOẠT ĐỘNG NUÔI TRỒNG THỦY SẢN CÓ QUY MÔ TỪ 30.000 m3/ngày đêm TRỞ LÊN" previousLink="/he-thong-giam-sat/xa-thai-NTTS-lon-hon-30.000m3ngaydem" showHeadImage={true} layoutfull={true} />
