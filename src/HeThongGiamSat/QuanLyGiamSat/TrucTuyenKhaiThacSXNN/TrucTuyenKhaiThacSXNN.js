...
export default class HeThongGiamSatTrucTuyenKhaiThacSXNN extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT TRỰC TUYẾN ĐỐI VỚI HOẠT ĐỘNG KHAI THÁC HỒ CHỨA ĐỂ SẢN XUẤT NÔNG NGHIỆP / NUÔI TRỒNG THỦY SẢN/ VÀ CHO CÁC MỤC ĐÍCH KHÁC" previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
