...
//import HeThongGiamSatTrucTuyenKhaiThacSXNN from './GiamSatKhaiThacSXNN';
// import NhatKyCanhBao from './../../TrucTuyenKhaiThacSXNN copy/TrucTuyenKhaiThacSXNN/NhatKyCanhBao';
...
export default class HeThongGiamSatLichSuTrucTuyenKhaiThacSXNN extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT TRỰC TUYẾN ĐỐI VỚI HOẠT ĐỘNG KHAI THÁC HỒ CHỨA ĐỂ SẢN XUẤT NÔNG NGHIỆP / NUÔI TRỒNG THỦY SẢN/ VÀ CHO CÁC MỤC ĐÍCH KHÁC " previousLink="/he-thong-giam-sat/truc-tuyen-ho-chua-san-xuat-nong-nghiep" showHeadImage={true} layoutfull={true} />
                        ...
                        <div className="col-12 row align-items-center my-1 px-0 mx-0">
                            <Tabs tabPosition="top" defaultActiveKey="1">
                               ...
                               <TabPane tab="Giám sát xả dòng chảy tối thiểu" key="3"> 
                                ...
                                <TabPane tab="Giám sát lưu lượng khai thác sử dụng" key="4">
                                   <TongHopVanHanh />
                                </TabPane> 
