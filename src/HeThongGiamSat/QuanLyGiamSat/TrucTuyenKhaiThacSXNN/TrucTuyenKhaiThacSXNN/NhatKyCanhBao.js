...
export default class NhatKyCanhBao extends React.Component {
    constructor(props){
        super(props)
        this.state = {
            activeModal: null,
   ...
   // ĐOẠN 2
        ...
        const columnTramMatKetNoi = [
            ...
            {
                title: 'Mất kết nối',
                dataIndex: 'quantrac_matketnoi',
                key: 'quantrac_matketnoi',
                width: 80,
                align: 'center',
                render: (text, record) => (
                    <div className="d-flex justify-content-between">
                        {record.quantrac_matketnoi > 100 ?  
            ...
            },
            {
                title: () => (
                    <>
                        Giá trị <br /> mất kết nối
                    </>
                     
                ),
                dataIndex: 'quantrac_giatrimatketnoi',
                key: 'quantrac_giatrimatketnoi',
                width: 60,
                align: 'center',
                render: (text, record) => (
                    <div className="d-flex justify-content-between">
                        {record.quantrac_matketnoi > 100 ?  
                            <span className="text-center w-100"> {record.quantrac_matketnoi - 100} </span> 
                            : 
                            <span className="text-center w-100"> {record.quantrac_matketnoi - 100} </span>
                        }
                    </div>
        ...
        // COLUMN VUOT NGUONG TRONG NHAT KÝ CẢNH BÁO
        const columnTramVuotNguong = [
            ...
            {
                title: () => { 
                    return <span>Lưu lượng <br /> khai thác <br /> m3/s</span>
                } ,
