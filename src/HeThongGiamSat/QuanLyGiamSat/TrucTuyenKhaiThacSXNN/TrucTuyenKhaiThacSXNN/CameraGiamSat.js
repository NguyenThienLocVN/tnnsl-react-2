...
// hạng mục giám sát xả dòng chảy tối thiểu
...
// import CameraGiamSat from './../../XaThaiLonHon/XaThaiLonHon/CameraGiamSat copy';
//import GiamSatDuLieu from './../../PhatDienNhoHon2MW/LichSuPhatDienNhoHon2MW/GiamSatDuLieu';
//import GiamSatDuLieu from './../../TrucTuyenMucNuocHo copy/TrucTuyenMucNuocHo/GiamSatDuLieu';
//import CameraGiamSat from './../../PhatDienLonHon2MW copy/LichSuPhatDienLonHon2MW/CameraGiamSat';
...
const columnTram = [
  ...
  
    {
        ...
        title: () => { 
            return <span> Nguồn nước<br /> khai thác </span>
        } ,
        dataIndex: '',
        key: '',
    },
    ...
    {
        title: 'Lưu lượng xả duy trì dòng chảy tối thiểu (m3/s)',
        children: [
            {
                title: () => (
    ...
    {
        title: 'Giá trị vượt ngưỡng (m3/s)',
        children: [
            {
                title: () => (
                    <div className="text-center">
