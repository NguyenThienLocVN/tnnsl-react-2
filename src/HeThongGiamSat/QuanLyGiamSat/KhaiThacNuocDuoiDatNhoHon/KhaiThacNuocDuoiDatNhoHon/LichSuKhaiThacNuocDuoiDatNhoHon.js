    ...
    render(){
        return(
            <div className="pt-1 px-1">
                <Header headTitle="GIÁM SÁT HOẠT ĐỘNG KHAI THÁC, SỬ DỤNG NƯỚC DƯỚI ĐẤT ĐỐI VỚI CÔNG TRÌNH CÓ QUY MÔ NHỎ HƠN 3.000 m3/ngày đêm" previousLink="/he-thong-giam-sat/phat-dien-lon-hon-2mw" showHeadImage={true} layoutfull={true} />
