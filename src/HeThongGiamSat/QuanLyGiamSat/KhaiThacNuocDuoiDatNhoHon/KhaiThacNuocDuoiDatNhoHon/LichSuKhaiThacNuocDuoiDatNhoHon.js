...
export default class HeThongGiamSatLichSuKhaiThacNuocDuoiDatNhoHon extends React.Component {
    ...
    render(){
        return(
            <div>
                <Header headTitle="GIÁM SÁT HOẠT ĐỘNG KHAI THÁC, SỬ DỤNG NƯỚC DƯỚI ĐẤT ĐỐI VỚI CÔNG TRÌNH CÓ QUY MÔ NHỎ HƠN 3.000 m3/ngày đêm " previousLink="/he-thong-giam-sat/khai-thac-nuoc-duoi-dat-nho-hon" showHeadImage={true} layoutfull={true} />
