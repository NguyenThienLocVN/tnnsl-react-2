...
export default class HeThongGiamSatLichSuXaThaiLonHon extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT XẢ THẢI VÀO NGUỒN NƯỚC CÓ QUY MÔ TỪ 3000 m3/ngày đêm TRỞ LÊN " previousLink="/he-thong-giam-sat/xa-thai-lon-hon-3000m3ngaydem" showHeadImage={true} layoutfull={true} />
