...
export default class HeThongGiamSatXaThaiLonHon extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT XẢ THẢI VÀO NGUỒN NƯỚC CÓ QUY MÔ TỪ 3000 m3/ngày đêm TRỞ LÊN" previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
