...
export default class KhaiThacNDD extends React.Component {
    ...
    render(){
        ...
        return(
            <div className="pt-1 px-1">
                <Header headTitle="CÔNG TRÌNH KHAI THÁC SỬ DỤNG NƯỚC DƯỚI ĐẤT CÓ QUY MÔ LỚN HƠN 3.000 m3/ngày.đêm" previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
