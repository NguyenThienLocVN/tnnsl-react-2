...
export default class HeThongGiamSatLichSuTrucTuyenXaDongChayQuaNhaMay extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT TRỰC TUYẾN LƯU LƯỢNG XẢ QUA NHÀ MÁY " previousLink="/he-thong-giam-sat/truc-tuyen-muc-nuoc-ho-chua" showHeadImage={true} layoutfull={true} />
