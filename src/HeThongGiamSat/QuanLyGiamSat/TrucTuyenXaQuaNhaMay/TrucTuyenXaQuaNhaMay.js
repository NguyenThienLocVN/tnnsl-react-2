...
export default class HeThongGiamSatTrucTuyenXaQuaNhaMay extends React.Component {
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        return(
            <div>
                <Header headTitle="HỆ THỐNG GIÁM SÁT TRỰC TUYẾN LƯU LƯỢNG XẢ QUA NHÀ MÁY" previousLink="/he-thong-giam-sat" showHeadImage={true} layoutfull={true} />
