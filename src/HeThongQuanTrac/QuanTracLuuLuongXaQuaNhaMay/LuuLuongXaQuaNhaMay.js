...
export default class HeThongQuanTracNuocMatLuuLuongXaQuaNhaMay extends React.Component{
    ...
    componentDidMount(){
        document.title = "Hệ thống quan trắc | Lưu lượng xả qua nhà máy | Giám sát tài nguyên nước Sơn La";
    ...
    render(){
        ...
        return(
            <div className="p-0">
                <Header headTitle="QUAN TRẮC | NƯỚC MẶT | LƯU LƯỢNG XẢ QUA NHÀ MÁY " previousLink="/he-thong-quan-trac" showHeadImage={true} layoutfull={true} />
