...
export default class HeThongQuanTracNuocMatLuuLuongNuocXaQuaNhaMay extends React.Component{
    constructor(props){
        super(props)
        this.state = { 
    ...
    componentDidMount(){
        // PAGE TITLE
        document.title = "Hệ thống quan trắc | Xả qua nhà máy | Giám sát tài nguyên nước Sơn La";
    ...
    render(){
          ...
          const optionLine = {
            ...
            scales: {
                ...
                yAxes: {
                    ...
                    title: {
                        display: true,
                        text: 'Lưu lượng nước xả qua NM (m³/s)'
                    },
                }
            }
          };
        ...
        const dataTram = [
            {
                key: '1',
                id: '1',
                tenho: 'Trạm quan trắc lưu lượng nước xả qua nhà máy số 1 tỉnh Sơn La',
                luuluongnuocxaquanm: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '2',
                id: '2',
                tenho: 'Trạm quan trắc lưu lượng nước xả qua nhà máy số 2 tỉnh Sơn La',
                luuluongnuocxaquanm: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '3',
                id: '3',
                tenho: 'Trạm quan trắc lưu lượng nước xả qua nhà máy số 3 tỉnh Sơn La',
                luuluongnuocxaquanm: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '4',
                id: '4',
                tenho: 'Trạm quan trắc lưu lượng nước xả qua nhà máy số 4 tỉnh Sơn La',
                luuluongnuocxaquanm: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '5',
                id: '5',
                tenho: 'Trạm quan trắc lưu lượng nước xả qua nhà máy số 5 tỉnh Sơn La',
                luuluongnuocxaquanm: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '6',
                id: '6',
                tenho: 'Trạm quan trắc lưu lượng nước xả qua nhà máy số 6 tỉnh Sơn La',
                luuluongnuocxaquanm: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '7',
                id: '7',
                tenho: 'Trạm quan trắc lưu lượng nước xả qua nhà máy số 7 tỉnh Sơn La',
                luuluongnuocxaquanm: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '8',
                id: '8',
                tenho: 'Trạm quan trắc lưu lượng nước xả qua nhà máy số 8 tỉnh Sơn La',
                luuluongnuocxaquanm: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '9',
                id: '9',
                tenho: 'Trạm quan trắc lưu lượng nước xả qua nhà máy số 9 tỉnh Sơn La',
                luuluongnuocxaquanm: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '10',
                id: '10',
                tenho: 'Trạm quan trắc lưu lượng nước xả qua nhà máy số 10 tỉnh Sơn La',
                luuluongnuocxaquanm: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '11',
                id: '11',
                tenho: 'Trạm quan trắc lưu lượng nước xả qua nhà máy số 11 tỉnh Sơn La',
                luuluongnuocxaquanm: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
        ...
        const columnTram = [
                    ...
                    <div className="m-0 fw-bold">
                        <p className="m-0 d-flex align-items-center">
                            ...
                            <span className="d-inline-block">
                                <span className="p-1 d-flex align-items-center justify-content-center text-primary" onClick={(e) => this.clickHandler(e, record.id, record.tenho)}>
                                    {record.tenho}
                                </span>
                                <Modal
                                        ...
                                        <div className="modal_quantrac">
                                                ...
                                                <div className="row p-0 mx-0 m-2 align-items-center ">
                                                    <div className="d-flex align-items-center col-sm-4">
                                                        ...
                                                        <div className="row col-auto m-0 p-0">
                                                            <span className="col-12 text-nowrap p-0">Q<sub>xả NM</sub></span>
                                                            <span className="col-12 text-nowrap p-0">thực đo</span>
                                                        </div>
                                                        <div>
                                                            <span className="d-flex"> = <span className="fw-bold text-primary px-1"> 0 </span>(m³/s)</span>
                                                        </div>
                                                    </div>
                                                    {/* FILTER FORM */}
                                            ...
                                            <Tabs type="card" tabPosition="left" defaultActiveKey="1" type="card">
                                                <TabPane tab="Biểu Đồ" key="1">
                                                    {/* Line CHARTS LUU LUONG XA QUA NHA MAY */}
                                                    <div className="d-flex align-items-end">
                                                        <Line width={600} height={400} data={dataLine} options={optionLine} />
                                                    </div>
                                                    {/* END Line CHARTS LUU LUONG XA QUA NHA MAY */}
                                                </TabPane>
                                                <TabPane tab="Bảng Biểu" key="2">
                                                    {/* FORM SHOW DATA LUU LUONG XA QUA NHA MAY */}
                                                    <Form>
                                                        <div className="row m-0 p-0">
                                                            <div className="col-sm-6 p-2">
                                                                <Table bordered 
                                                                dataSource={dataBangBieuLuuLuongXaQuaNhaMay1} 
                                                                columns={columnBangBieuLuuLuongXaQuaNhaMay}
                                                                pagination={false}
                                                                />
                                                            </div>
                                                            <div className="col-sm-6 p-2">
                                                                <Table bordered 
                                                                dataSource={dataBangBieuLuuLuongXaQuaNhaMay2} 
                                                                columns={columnBangBieuLuuLuongXaQuaNhaMay}
                                                                pagination={false}
                                                                />
                                                            </div>
                                                    ...
                                                    {/* END FORM SHOW DATA LUU LUONG XA QUA NHA MAY */}
                                                </TabPane>
                                                <TabPane tab="Cập Nhật" key="3">
                                                    {/* FORM UPDATE DATA LUU LUONG XA QUA NHA MAY */}
                                                    <Form>
                                                        <div className="row m-0 p-0">
                                                            <div className="col-sm-6 p-2">
                                                                <Table bordered 
                                                                dataSource={dataBangBieuLuuLuongXaQuaNhaMay1} 
                                                                columns={columnCapNhatLuuLuongXaQuaNhaMay}
                                                                pagination={false}
                                                                />
                                                            </div>
                                                            <div className="col-sm-6 p-2">
            ...
            {
                title: 'Qđến',
                dataIndex: 'luuluongnuocdenho',
                key: 'luuluongnuocdenho',
                align: 'center',
                render: (text, record, index) => (
                    <>
                        <div>
                            <p className="fw-bold m-0">{record.luuluongnuocdenho} <br/> <span className="fw-normal">(m³/s)</span> </p>
                        </div>
                    </>
                ),
            },
            {
                title: 'Qxả NM',
                dataIndex: 'luuluongnuocxaquanm',
                key: 'luuluongnuocxaquanm',
                align: 'center',
                render: (text, record, index) => (
                    <>
                        <div>
                            <p className="fw-bold m-0">{record.luuluongnuocxaquanm} <br/> <span className="fw-normal">(m³/s)</span> </p>
                        </div>
                    </>
                ),
            },
        ...
        // DATA LUU LUONG XA QUA NHA MAY
        const dataBangBieuLuuLuongXaQuaNhaMay1 = [
            {
                key: '1',
                id: '1',
                giamsat_ngay: '22/08/2021',
                giamsat_gio: '00:00',
                giamsat_luuluongnuocxaquanm: '0',
            },
            {
                key: '2',
                id: '2',
        ...
        const dataBangBieuLuuLuongXaQuaNhaMay2 = [
            {
                key: '13',
                id: '13',
                giamsat_ngay: '22/08/2021',
        ...
        // COLUMN SHOW LUU LUONG XA QUA NHA MAY
        const columnBangBieuLuuLuongXaQuaNhaMay = [
            {
                title: '#',
                dataIndex: 'id',
                key: 'id',
            ...
            {
                title: 'Lưu lượng nước xả qua NM (m³/s)',
                dataIndex: 'giamsat_luuluongnuocxaquanm',
                key: 'giamsat_luuluongnuocxaquanm',
                align: 'center',
                render: (text, record) => (
                    <>
                        <Input size="small" readOnly defaultValue={record.giamsat_luuluongnuocxaquanm} />
                    </>
                )
            },
        ];
        // COLUMN UPDATE LUU LUONG XA QUA NHA MAY
        const columnCapNhatLuuLuongXaQuaNhaMay = [
            {
                title: '#',
                dataIndex: 'id',
                key: 'id',
            ...
            },
            {
                ...
                render: (text, record) => (
                    <>
                        <Input size="small" defaultValue={record.giamsat_luuluongnuocxaquanm} />
                    </>
                )
            },
        ];
        ...
        // BUILE TITLE MODAL
        const title = (
            <BuildTitle visible={this.state.visible} title={"SỐ LIỆU QUAN TRẮC LƯU LƯỢNG NƯỚC XẢ QUA NHÀ MÁY- "+this.state.TenTramQuanTrac} />
        );
        return(
            <div className="p-0">
                <Header headTitle="QUAN TRẮC LƯU LƯỢNG NƯỚC XẢ QUA NHÀ MÁY" previousLink="/he-thong-quan-trac" showHeadImage={true} layout37={true} />
                <main className="row m-0 p-0">
                    <div className="col-12 col-lg-3 px-0 menu-home">
                        ...
                        <div className="px-2">
                            {/* TABLE SHOW LIST TRAM QUAN TRAC LUU LUONG XA QUA NHA MAY */}
                            <Table bordered dataSource={dataTram} columns={columnTram} />
                            {/* END TABLE SHOW LIST TRAM QUAN TRAC LUU LUONG XA QUA NHA MAY */}
                        </div>
                    </div>
                    <div className="col-12 col-lg-9 map-container px-md-0 position-relative">
                        ...
                        <MapContainer className="col-12 h-100 w-100" whenCreated={ mapInstance => { this.mapRef.current = mapInstance } } center={this.state.center} zoom={this.state.zoom}>
                            ...
                            {/* POPUP TRAM QUAN TRAC LUU LUONG XA QUA NHA MAY */}
                            { this.state.dataSource.map((marker, key) => (
                                    ...
                                    <Popup>
                                    <div>
                                        <h5 className="card-title fw-bold font-13">Trạm - {marker.location_name}</h5>
                                    </div>
                                    </Popup>
                                </Marker> : ""
                                ))
