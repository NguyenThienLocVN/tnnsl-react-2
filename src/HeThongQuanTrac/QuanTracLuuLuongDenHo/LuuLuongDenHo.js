...
export default class HeThongQuanTracNuocMatLuuLuongNuocDenHo extends React.Component{
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
          ...
          const optionLine = {
            ...
            scales: {
                ...
                yAxes: {
                    ...
                    title: {
                        display: true,
                        text: 'Lưu lượng nước đến hồ (m³/s)'
                    },
                }
            }
          };
        ...
        const dataTram = [
            {
                key: '1',
                id: '1',
                tenho: 'Trạm quan trắc lưu lượng nước đến hồ số 1 tỉnh Sơn La',
                mucnuocho: 725.1,
            ...
            },
            {
                key: '2',
                id: '2',
                tenho: 'Trạm quan trắc lưu lượng nước đến hồ số 2 tỉnh Sơn La',
                mucnuocho: 725.1,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '3',
                id: '3',
                tenho: 'Trạm quan trắc lưu lượng nước đến hồ số 3 tỉnh Sơn La',
                mucnuocho: 725.1,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '4',
                id: '4',
                tenho: 'Trạm quan trắc lưu lượng nước đến hồ số 4 tỉnh Sơn La',
                mucnuocho: 725.1,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '5',
                id: '5',
                tenho: 'Trạm quan trắc lưu lượng nước đến hồ số 5 tỉnh Sơn La',
                mucnuocho: 725.1,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '6',
                id: '6',
                tenho: 'Trạm quan trắc lưu lượng nước đến hồ số 6 tỉnh Sơn La',
                mucnuocho: 725.1,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '7',
                id: '7',
                tenho: 'Trạm quan trắc lưu lượng nước đến hồ số 7 tỉnh Sơn La',
                mucnuocho: 725.1,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '8',
                id: '8',
                tenho: 'Trạm quan trắc lưu lượng nước đến hồ số 8 tỉnh Sơn La',
                mucnuocho: 725.1,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '9',
                id: '9',
                tenho: 'Trạm quan trắc lưu lượng nước đến hồ số 9 tỉnh Sơn La',
                mucnuocho: 725.1,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '10',
                id: '10',
                tenho: 'Trạm quan trắc lưu lượng nước đến hồ số 10 tỉnh Sơn La',
                mucnuocho: 725.1,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '11',
                id: '11',
                tenho: 'Trạm quan trắc lưu lượng nước đến hồ số 11 tỉnh Sơn La',
                mucnuocho: 725.1,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
        ...
        const columnTram = [
                                        ...
                                        <div className="modal_quantrac">
                                                ...
                                                <div className="row p-0 mx-0 m-2 align-items-center ">
                                                    <div className="d-flex align-items-center col-sm-4">
                                                        ...
                                                        <div className="row col-auto m-0 p-0">
                                                            <span className="col-12 text-nowrap p-0">Q<sub>đến</sub></span>
                                            ...
                                            <Tabs type="card" tabPosition="left" defaultActiveKey="1" type="card">
                                                ...
                                                <TabPane tab="Bảng Biểu" key="2">
                                                    ...
                                                    {/* END FORM SHOW DATA LUU LUONG DEN HO */}
                                                </TabPane>
                                                <TabPane tab="Cập Nhật" key="3">
                                                    {/* FORM UPDATE DATA LUU LUONG DEN HO */}
                                                    <Form>
                                                        <div className="row m-0 p-0">
                                                            <div className="col-sm-6 p-2">
                                                                <Table bordered 
            ...
            },
            {
                ...
                render: (text, record, index) => (
                    <>
                        <div>
                            <p className="fw-bold m-0 text-nowrap">{record.mucnuocho}
                                <span className="fw-normal">(m)</span> 
                                <ArrowUpOutlined style={{position: "absolute", top: 0, color: "red", fontSize: 15}} /> 
                            </p>
                            <p className="m-0">Cập nhật <br /> {record.updatetime} </p>
                        </div>
                    </>
                ),
            },
            {
                ...
                render: (text, record, index) => (
                    <>
                        <div>
                            <p className="fw-bold m-0">{0} <br/> <span className="fw-normal">(tr.m³)</span> </p>
                            <p className="m-0 text-danger text-nowrap">Tỉ lệ: - % </p>
                        </div>
                    </>
                ),
            },
        ...
        const columnBangBieuLuongMua = [
            ...
            {
                title: 'Lưu lượng nước đến hồ (m³/s)',
                dataIndex: 'giamsat_luuluongnuocdenho',
                key: 'giamsat_luuluongnuocdenho',
                align: 'center',
                render: (text, record) => (
                    <>
                        <Input size="small" readOnly defaultValue={record.giamsat_luuluongnuocdenho} />
                    </>
                )
            },
        ];
        // COLUMN UPDATE LUU LUONG DEN HO
        const columnCapNhatLuongMua = [
            ...
            },
            {
                ...
                render: (text, record) => (
                    <>
                        <Input size="small" defaultValue={record.giamsat_luuluongnuocdenho} />
                    </>
                )
            },
        ];
        ...
        // BUILE TITLE MODAL
        const title = (
            <BuildTitle visible={this.state.visible} title={"SỐ LIỆU QUAN TRẮC LƯU LƯỢNG NƯỚC ĐẾN HỒ - "+this.state.TenTramQuanTrac} />
        );
        return(
            <div className="p-0">
                <Header headTitle="QUAN TRẮC LƯU LƯỢNG NƯỚC ĐẾN HỒ " previousLink="/he-thong-quan-trac" showHeadImage={true} layout37={true} />
                <main className="row m-0 p-0">
                    <div className="col-12 col-lg-3 px-0 menu-home">
                        ...
                        <div className="px-2">
                            {/* TABLE SHOW LIST TRAM QUAN TRAC LUU LUONG DEN HO */}
                            <Table bordered dataSource={dataTram} columns={columnTram} />
                            {/* END TABLE SHOW LIST TRAM QUAN TRAC LUU LUONG DEN HO */}
                        </div>
                    </div>
                    <div className="col-12 col-lg-9 map-container px-md-0 position-relative">
                        ...
                        <MapContainer className="col-12 h-100 w-100" whenCreated={ mapInstance => { this.mapRef.current = mapInstance } } center={this.state.center} zoom={this.state.zoom}>
                            ...
                            {/* POPUP TRAM QUAN TRAC LUU LUONG DEN HO */}
