...
export default class HeThongQuanTracNuocDuoiDatTheoDoiQuanTracMucNuocTrongGiengKhaiThac extends React.Component{
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
          ...
          const optionLine = {
            ...
            scales: {
                ...
                yAxes: {
                    ...
                    title: {
                        display: true,
                        text: 'Mực nước trong giếng khai thác (m)'
                    },
                    beginAtZero: true,
                    min: 0
                }
        ...
        return(
            <div className="p-0">
                <Header headTitle="QUAN TRẮC MỰC NƯỚC TRONG GIẾNG KHAI THÁC" previousLink="/he-thong-quan-trac/nuoc-duoi-dat/muc-nuoc-trong-gieng-khai-thac" showHeadImage={true} layout37={true} />
