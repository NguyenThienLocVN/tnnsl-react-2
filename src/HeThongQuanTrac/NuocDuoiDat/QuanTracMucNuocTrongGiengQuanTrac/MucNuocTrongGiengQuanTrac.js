...
export default class HeThongQuanTracNuocDuoiDatMucNuocTrongGiengQuanTrac extends React.Component{
    constructor(props){
        super(props)
        this.state = { 
    ...
    render(){
        ...
        const columnCongTrinh = [
            ...
            },
            {
                ...
                render: (text, record, index) => (
                    <>
                        <Link to={"/he-thong-quan-trac/nuoc-duoi-dat/muc-nuoc-trong-gieng-quan-trac/theo-doi-quan-trac/"+record.id} onClick={(e) => this.clickHandler(e, record.id, record.gp_sogiayphep, record.congtrinh_ten)}>Xem</Link>
                    </>
                ),
            },
        ];
        ...
        return(
            <div className="p-0">
                <Header headTitle="QUAN TRẮC MỰC NƯỚC TRONG GIẾNG QUAN TRẮC " previousLink="/he-thong-quan-trac" showHeadImage={true} layout37={true} />
