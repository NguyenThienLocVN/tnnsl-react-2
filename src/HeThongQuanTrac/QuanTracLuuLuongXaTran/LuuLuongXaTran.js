...
export default class HeThongQuanTracNuocMatLuuLuongXaTran extends React.Component{
    constructor(props){
        super(props)
        this.state = { 
    ...
    componentDidMount(){
        document.title = "Hệ thống quan trắc | Lưu lượng xả qua tràn | Giám sát tài nguyên nước Sơn La";
    ...
    render(){
        ...
        return(
            <div className="p-0">
                <Header headTitle="HỆ THỐNG QUAN TRẮC/ NƯỚC MẶT / LƯU LƯỢNG XẢ TRÀN " previousLink="/he-thong-quan-trac" showHeadImage={true} layoutfull={true} />
                        ...
                        <Table striped bordered hover responsive>
                            <thead className="bg-lightblue">
                                <tr>
                                    ...
                                    <th className="text-center text-nowrap align-center">Q <sub>xả tràn</sub></th>
                                </tr>
                            </thead>
                            <tbody>
