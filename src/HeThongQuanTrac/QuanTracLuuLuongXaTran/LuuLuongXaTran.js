...
export default class HeThongQuanTracNuocMatLuuLuongNuocXaTran extends React.Component{
    constructor(props){
        super(props)
        this.state = { 
    ...
    componentDidMount(){
        // PAGE TITLE
        document.title = "Hệ thống quan trắc | Xả tràn | Giám sát tài nguyên nước Sơn La";
    ...
    render(){
          ...
          const optionLine = {
            ...
            scales: {
                ...
                yAxes: {
                    ...
                    title: {
                        display: true,
                        text: 'Lưu lượng nước xả tràn (m³/s)'
                    },
                }
            }
          };
        ...
        const dataTram = [
            {
                key: '1',
                id: '1',
                tenho: 'Trạm quan trắc lưu lượng nước xả tràn số 1 tỉnh Sơn La',
                luuluongnuocxatran: 0.10,
            ...
            },
            {
                key: '2',
                id: '2',
                tenho: 'Trạm quan trắc lưu lượng nước xả tràn số 2 tỉnh Sơn La',
                luuluongnuocxatran: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '3',
                id: '3',
                tenho: 'Trạm quan trắc lưu lượng nước xả tràn số 3 tỉnh Sơn La',
                luuluongnuocxatran: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '4',
                id: '4',
                tenho: 'Trạm quan trắc lưu lượng nước xả tràn số 4 tỉnh Sơn La',
                luuluongnuocxatran: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '5',
                id: '5',
                tenho: 'Trạm quan trắc lưu lượng nước xả tràn số 5 tỉnh Sơn La',
                luuluongnuocxatran: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '6',
                id: '6',
                tenho: 'Trạm quan trắc lưu lượng nước xả tràn số 6 tỉnh Sơn La',
                luuluongnuocxatran: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '7',
                id: '7',
                tenho: 'Trạm quan trắc lưu lượng nước xả tràn số 7 tỉnh Sơn La',
                luuluongnuocxatran: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '8',
                id: '8',
                tenho: 'Trạm quan trắc lưu lượng nước xả tràn số 8 tỉnh Sơn La',
                luuluongnuocxatran: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '9',
                id: '9',
                tenho: 'Trạm quan trắc lưu lượng nước xả tràn số 9 tỉnh Sơn La',
                luuluongnuocxatran: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '10',
                id: '10',
                tenho: 'Trạm quan trắc lưu lượng nước xả tràn số 10 tỉnh Sơn La',
                luuluongnuocxatran: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
            {
                key: '11',
                id: '11',
                tenho: 'Trạm quan trắc lưu lượng nước xả tràn số 11 tỉnh Sơn La',
                luuluongnuocxatran: 0.10,
                luuluongnuocdenho: 0.15,
                updatetime: "07:00",
            },
        ...
        const columnTram = [
                                        ...
                                        <div className="modal_quantrac">
                                                ...
                                                <div className="row p-0 mx-0 m-2 align-items-center ">
                                                    <div className="d-flex align-items-center col-sm-4">
                                                        ...
                                                        <div className="row col-auto m-0 p-0">
                                                            <span className="col-12 text-nowrap p-0">Q<sub>xả tràn</sub></span>
                                            ...
                                            <Tabs type="card" tabPosition="left" defaultActiveKey="1" type="card">
                                                <TabPane tab="Biểu Đồ" key="1">
                                                    {/* Line CHARTS LUU LUONG XA TRAN */}
                                                    <div className="d-flex align-items-end">
                                                        <Line width={600} height={400} data={dataLine} options={optionLine} />
                                                    </div>
                                                    {/* END Line CHARTS LUU LUONG XA TRAN */}
                                                </TabPane>
                                                <TabPane tab="Bảng Biểu" key="2">
                                                    {/* FORM SHOW DATA LUU LUONG XA TRAN */}
                                                    <Form>
                                                    ...
                                                    {/* END FORM SHOW DATA LUU LUONG XA TRAN */}
                                                </TabPane>
                                                <TabPane tab="Cập Nhật" key="3">
                                                    {/* FORM UPDATE DATA LUU LUONG XA TRAN */}
                                                    <Form>
                                                        <div className="row m-0 p-0">
                                                            <div className="col-sm-6 p-2">
                                                                <Table bordered 
            ...
            {
                title: 'Qxả tràn',
                dataIndex: 'luuluongnuocxatran',
                key: 'luuluongnuocxatran',
                align: 'center',
                render: (text, record, index) => (
                    <>
                        <div>
                            <p className="fw-bold m-0">{record.luuluongnuocxatran} <br/> <span className="fw-normal">(m³/s)</span> </p>
                        </div>
                    </>
                ),
            },
        ...
        const columnBangBieuLuuLuongXaQuaNhaMay = [
            ...
            {
                title: 'Lưu lượng nước xả tràn (m³/s)',
                dataIndex: 'giamsat_luuluongnuocxatran',
                key: 'giamsat_luuluongnuocxatran',
                align: 'center',
                render: (text, record) => (
                    <>
                        <Input size="small" readOnly defaultValue={record.giamsat_luuluongnuocxatran} />
                    </>
                )
            },
        ];
        // COLUMN UPDATE LUU LUONG XA TRAN
        const columnCapNhatLuuLuongXaQuaNhaMay = [
            ...
            },
            {
                ...
                render: (text, record) => (
                    <>
                        <Input size="small" defaultValue={record.giamsat_luuluongnuocxatran} />
                    </>
                )
            },
        ];
        ...
        // BUILE TITLE MODAL
        const title = (
            <BuildTitle visible={this.state.visible} title={"SỐ LIỆU QUAN TRẮC LƯU LƯỢNG NƯỚC XẢ TRÀN- "+this.state.TenTramQuanTrac} />
        );
        return(
            <div className="p-0">
                <Header headTitle="QUAN TRẮC LƯU LƯỢNG NƯỚC XẢ TRÀN" previousLink="/he-thong-quan-trac" showHeadImage={true} layout37={true} />
                <main className="row m-0 p-0">
                    <div className="col-12 col-lg-3 px-0 menu-home">
                        ...
                        <div className="px-2">
                            {/* TABLE SHOW LIST TRAM QUAN TRAC LUU LUONG XA TRAN */}
                            <Table bordered dataSource={dataTram} columns={columnTram} />
                            {/* END TABLE SHOW LIST TRAM QUAN TRAC LUU LUONG XA TRAN */}
                        </div>
                    </div>
                    <div className="col-12 col-lg-9 map-container px-md-0 position-relative">
                        ...
                        <MapContainer className="col-12 h-100 w-100" whenCreated={ mapInstance => { this.mapRef.current = mapInstance } } center={this.state.center} zoom={this.state.zoom}>
                            ...
                            {/* POPUP TRAM QUAN TRAC LUU LUONG XA TRAN */}
